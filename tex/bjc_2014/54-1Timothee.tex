...
\TextTitle{[Mise en garde contre les erreurs dans la doctrine et la vie chrétiennes]}
...
\TextTitle{[Témoignages personnel de Paul et recommandations à Timothée]}
...
\TextTitle{[Instructions sur la prière et sur le rôle des femmes dans l'Eglise]}
\Chap{2}
...
\VS{12}Car je ne permets pas à la femme d'enseigner ni de prendre de l’autorité\FTNT{Le mot ~autorité~ vient du grec ~authenteo~ et signifie ~celui qui tue de ses propres mains un autre ou lui-même ; celui qui agit de sa propre autorité, autocrate ; un maître absolu ; gouverneur, exercer une domination~.} sur son mari ; mais elle doit demeurer dans le silence\FTNT{Le mot grec traduit par ~silence~ est ~hesuchia~ qui signifie ~en silence ; paisiblement~. La racine de ce terme est ~hesuchios~ : tranquille, paisible.}.
...
\VS{15}Elle sera néanmoins sauvée en devenant mère\FTNT{Il est évident que le salut ne dépend pas du fait d’enfanter puisque nous sommes sauvés par grâce et non par les œuvres. Ce verset fait référence à Eve, la mère de tous les vivants. Par elle le péché et la mort sont entrés dans le monde (Ro. 5:12) mais c’est aussi par sa postérité, à savoir Christ (Ge. 3:15), qu’elle, ainsi que tout le genre humain (hommes et femmes), sera sauvé.}, si elle persévère avec modestie dans la foi, dans la charité, et dans la sanctification.
...
\TextTitle{[Le travail d'un bon serviteur de Jésus-Christ]}
\Chap{5}
...
\VS{12}et se rendant coupables en ce qu’elles violent leur premier engagement\FTNT{Le verset 11 permet de comprendre qu’il ne s’agit pas de l’engagement envers leurs maris décédés, puisqu’il est permis aux veufs de se remarier (Ro. 7:3), mais de l’engagement envers Jésus-Christ.}.
...
\TextTitle{[Avertissements à un bon serviteur de Jésus-Christ]}
\Chap{6}
