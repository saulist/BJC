...
\VS{5}et je dis au roi : Si le roi le trouve bon, et si ton serviteur lui est agréable, envoie-moi en Juda, vers la ville des sépulcres de mes pères, pour que je la rebâtisse\FTNT{La reconstruction de la ville de Jérusalem sous Néhémie date, selon certains, de l’an 445 av. J.-C., suite au décret d’Artaxerxès. Cette date marquerait le point de départ des soixante-dix semaines d’années annoncées par Daniel (Da. 9:24-27).}.
