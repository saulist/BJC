...
\TextTitle{[l'Evangile prêché avec puissance, avec l'Esprit-Saint et avec persuasion]}
...
\TextTitle{[La récompense du serviteur modèle]}
\Chap{2}
...
\TextTitle{[Le frère en Christ et sa sanctification]}
\Chap{3}
...
\TextTitle{[La marche du croyant]}
\Chap{4}
