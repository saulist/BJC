...
\VS{6}Tu as pourtant ceci, c’est que tu hais les œuvres des Nicolaïtes{\FTNT{Nicolaïtes : Tiré du nom Nicolas, qui signifie littéralement «~victorieux du peuple~». Il s’agit d’une secte dont les membres furent peut-être des disciples d’un certain Nicolas, l’un des diacres de l’église d’Antioche qui aurait dévié (Ac. 6:5). Ces derniers suivaient la doctrine de Balaam, enseignant aux chrétiens qu’à cause du principe de liberté, ils pouvaient manger des viandes sacrifiées aux idoles et commettre des actes immoraux comme les gentils.}}, œuvres que je hais aussi.
...
\VS{20}Ô ciel ! Réjouis-toi à cause d'elle ; et vous aussi, les saints, les apôtres et les prophètes, réjouissez-vous ! Car Dieu vous a fait justice en la jugeant.
...
\TextTitle{[Satan lié pour mille ans]}
\Chap{20}
