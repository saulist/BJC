...
\begin{center}
\textit{[Jésus-Christ se révèle à Jean et lui ordonne d'écrire aux pasteurs des sept Eglises d'Asie]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Lettres écrites par le commandement de Jésus-Christ aux pasteurs d'Ephèse]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Lettres écrites par le commandement de Jésus-Christ aux pasteurs des Eglises de Sardes]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[Vision de la majesté célébrée par les quatre animaux et les vingt-quatre Anciens]}
\end{center}
\Chap{4}
...
\begin{center}
\textit{[Vision du livre scellé de sept sceaux]}
\end{center}
\Chap{5}
...
\begin{center}
\textit{[L'Agneau est seul digne de l'ouvrir - Tous lui rendent hommage]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[L'Agneau rompt les six premiers sceaux du livre]}
\end{center}
\Chap{6}
...
\begin{center}
\textit{[Les serviteurs de Dieu marqués d'un sceau]}
\end{center}
\Chap{7}
...
\begin{center}
\textit{[Félicité des élus dans le ciel]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le septième sceau est ouvert ; les quatre premiers anges sonnent de la trompette, et divers fléaux se répandent sur la terre]}
\end{center}
\Chap{8}
...
\begin{center}
\textit{[Le cinquième ange sonne de la trompette]}
\end{center}
\Chap{9}
...
\begin{center}
\textit{[Le sixième ange sonne de la trompette, signe de nouveaux fléaux]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Un ange descend du ciel tenant à la main un livre qu'il donne à saint Jean pour le dévorer]}
\end{center}
\Chap{10}
...
\begin{center}
\textit{[Les deux témoins sont tués par la bête ; mais ils ressuscitent et sont élevés au ciel]}
\end{center}
\Chap{11}
...
\begin{center}
\textit{[Le septième ange sonne de la trompette ; tout est soumis au Seigneur et à son Christ ; cantique des vingt-quatre Anciens]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Vision de la femme enceinte et du dragon]}
\end{center}
\Chap{12}
...
\begin{center}
\textit{[Le dragon vaincu par les anges]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le dragon persécute encore la femme et ses enfantsJésus-Christ]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Deux bêtes, l'une sortant de la mer]}
\end{center}
\Chap{13}
...
\begin{center}
\textit{[l'autre bête montant de la terre, pour blasphémer et séduireJésus-Christ]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[L'Agneau sur la montagne de Sion et ses rachetés]}
\end{center}
\Chap{14}
...
\begin{center}
\textit{[L'Evangile éternel. Chute de Babylone et punition des adorateurs de la bête]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Cantique des vainqueurs de la bête]}
\end{center}
\Chap{15}
...
\begin{center}
\textit{[Les sept anges et les sept coupes de la colère de Dieu]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Description des sept dernières plaies versées sur la terre]}
\end{center}
\Chap{16}
...
\begin{center}
\textit{[Prophétie touchant le mystère de la grande prostituée, et prédiction de sa chute]}
\end{center}
\Chap{17}
...
\begin{center}
\textit{[Description prophétique de la ruine de la grande Babylone]}
\end{center}
\Chap{18}
...
\begin{center}
\textit{[Actions de grâces touchant le jugement de Dieu sur Babylone]}
\end{center}
\Chap{19}
...
\begin{center}
\textit{[Le Fidèle et le Véritable ; les armées du ciel]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Victoire sur la bête et le faux prophète]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Satan lié pour mille ans. Règne de mille ans]}
\end{center}
\Chap{20}
...
\begin{center}
\textit{[Satan délié ; puis vaincu pour la dernière fois]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le nouveau ciel, la nouvelle terre, la nouvelle Jérusalem ; consolation et félicité des élus]}
\end{center}
\Chap{21}
...
\begin{center}
\textit{[Description de la Jérusalem céleste]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Suite de la description de la félicité des élus dans la Jérusalem céleste]}
\end{center}
\Chap{22}
...
\begin{center}
\textit{[Certitude des prophéties de ce livre]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Nul ne doit y ajouter ou retrancher]}
\end{center}
\PPE{}
