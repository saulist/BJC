...
\TextTitle{[Actions de grâces touchant le jugement de Dieu sur Babylone]}
\Chap{19}
...
\TextTitle{[Le Fidèle et le Véritable ; les armées du ciel]}
...
\TextTitle{[Victoire sur la bête et le faux prophète]}
...
\TextTitle{[Satan lié pour mille ans. Règne de mille ans]}
\Chap{20}
...
\TextTitle{[Satan délié ; puis vaincu pour la dernière fois]}
...
\TextTitle{[Le nouveau ciel, la nouvelle terre, la nouvelle Jérusalem ; consolation et félicité des élus]}
\Chap{21}
...
\TextTitle{[Description de la Jérusalem céleste]}
...
\TextTitle{[Suite de la description de la félicité des élus dans la Jérusalem céleste]}
\Chap{22}
