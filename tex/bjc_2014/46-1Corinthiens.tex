...
\TextTitle{[Exhortation à l'union]}
...
\TextTitle{[La folie de la croix confond la fausse sagesse du monde]}
...
\TextTitle{[Caractère et objet de la prédication de l'apôtre]}
\Chap{2}
...
\TextTitle{[La sagesse de Dieu dans l'Evangile, mystère que l'Esprit a révélé et fait seul comprendre]}
...
\TextTitle{[Divisions blâmables au sujet des ministres de la Parole ]}
\Chap{3}
...
\TextTitle{[L'édifice de Dieu n'a qu'un seul fondement, Jésus-Christ]}
...
\TextTitle{[Paul, serviteur de Christ, en appelle au jugement du Seigneur]}
\Chap{4}
...
\TextTitle{[Orgueil des Corinthiens opposé à l'humiliation de l'apôtre, qui est leur père en Jésus-Christ]}
...
\TextTitle{[Condamnation d'un incestueux]}
\Chap{5}
...
\TextTitle{[Exhortation à fuir le commerce des vicieux]}
