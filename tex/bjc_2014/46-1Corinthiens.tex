...
\TextTitle{[Des viandes offertes aux idoles]}
\Chap{8}
...
\TextTitle{[De l'usage de la liberté chrétienne]}
...
\TextTitle{[L'apôtre a le droit de vivre de l'Evangile]}
\Chap{9}
...
\TextTitle{[Libre d'user de ce droit, Paul s'en est abstenu]}
...
\TextTitle{[Condescendance de Paul]}
...
\TextTitle{[La course et le combat du fidèle]}
...
\TextTitle{[L'apôtre, par l'exemple des Israélites au désert, prémunit les Corinthiens contre les chutes]}
\Chap{10}
...
\TextTitle{[Paul met en garde les Corinthiens contre les festins des idolâtres]}
...
\TextTitle{[Des viandes sacrifiées aux idoles]}
...
\TextTitle{[Faire toutes choses à la gloire de Dieu]}
...
\TextTitle{[Directions au sujet des assemblées]}
...
\TextTitle{[Le repas du Seigneur et l'abus dénoncés par l'apôtre]}
...
\TextTitle{[Institution de cette ordonnance]}
...
\TextTitle{[Diversité de dons provenant d'un même Esprit]}
\Chap{12}
...
\TextTitle{[La charité et ses caractères et son excellence]}
\Chap{13}
...
\TextTitle{[De l'ordre dans les assemblées]}
...
\TextTitle{[Certitude de la résurrection du Seigneur]}
\Chap{15}
...
\TextTitle{[L'importance de la résurrection du Seigneur]}
...
\TextTitle{[Christ ressuscité, prémices de ceux qui sont morts]}
...
\TextTitle{[Nature des corps ressuscités]}
...
\TextTitle{[L'homme terrestre et l'homme céleste]}
...
\TextTitle{[L'immortalité et la victoire du chrétien]}
...
\TextTitle{[Collecte pour les fidèles de Jérusalem]}
\Chap{16}
