...
\begin{multicols}{2}
\TextTitle{[La position en Christ du croyant dans la grâce]
\\(cp. Ro. 5:1-2 ; Ep. 1:3-14)}
\Chap{1}
...
\TextTitle{[La sagesse humaine, cause de divisions dans le corps de Christ]}
...
\TextTitle{[La sagesse humaine en opposition à la sagesse divine manifestée à la croix]}
...
\TextTitle{[Peu de sages selon la chair parmi les Corinthiens]}
...
\TextTitle{[La révélation chrétienne n'est en rien redevable à la sagesse humaine
a. Paul ne se fiait à la sagesse humaine]}
\Chap{2}
...
\TextTitle{[b. Les vérités spirituelles ne proviennent pas de la sagesse humaine, mais de la révélation divine]}
...
\TextTitle{[c. Les choses révélées sont enseignées avec le langage de l'Esprit]}
...
\TextTitle{[d. Les choses révélées sont discernées par grâce à l'Esprit]}
...
\TextTitle{[Un état charnel empêche la croissance spirituelle]}
\Chap{3}
...
\TextTitle{[Dieu seul importe dans le service chrétien]}
...
\TextTitle{[Le service chrétien et sa récompense]}
...
\TextTitle{[c. Il n'appartient pas aux hommes de juger les serviteurs de Christ]}
\Chap{4}
...
\TextTitle{[L'indifférence au mal dans l'Eglise résulte des  divisions]}
...
\TextTitle{[Le disciple est dans le monde, sans être du monde]}
...
\TextTitle{[Procès interdit entre chrétiens et face au non-croyants]}
\Chap{6}
...
\TextTitle{[Le chrétien est saint car il est lavé et justifié]}
...
\TextTitle{[Le chrétien est saint car il appartient au Seigneur]}
...
\TextTitle{[Le chrétien est saint car il est le temple de Dieu]}
...
\TextTitle{[Recommandation pour ceux qui sont mariés]}
...
\TextTitle{[Conséquences pratiques de l'appel divin]}
...
\TextTitle{[Paul défend son apostolat]
\\(cp. Ga. 1:11-2:21)}
\Chap{9}
...
\TextTitle{[Les prédications de l'Evangile doivent vivre de l'Evangile]}
...
\TextTitle{[Méthode et récompense d'un vrai serviteur de Dieu]}
...
\TextTitle{[Les expériences dans le désert citées en exemples]}
...
\TextTitle{[La loi de l'amour en relation avec le manger et le boire]
\\(cp. Ro. 14:1-23)}
...
\TextTitle{[Le repas du Seigneur et l'abus dénoncés par Paul]}
...
\TextTitle{[Signification et déroulement du repas du Seigneur]}
...
\TextTitle{[L'exercice des dons spirituels à la base du vrai ministère]
\\(cp. Ep. 4:7-16)}
...
\TextTitle{[Chaque disciple est membres du corps de Christ et possède un ministère déterminé]}
...
\TextTitle{[Les dons doivent s'exercer dans l'amour]}
\Chap{13}
...
\TextTitle{[Supériorité du don de prophétie]}
\Chap{14}
...
\TextTitle{[Prescription pour l'exercice des dons spirituels dans l'églises locales]}
...
\TextTitle{[Résurrection des morts]}
\\{[1. Le fait de la résurrection de Christ]}
\Chap{15}
...
\TextTitle{[2. Importance de la résurrection de Christ]}
...
\TextTitle{[3. Ordre des résurrections]}
...
\TextTitle{[4. Certitude de la résurrection]}
...
\TextTitle{[5. Corps de résurrection]}
...
\TextTitle{[Mystère de la résurrection]
\\(cp. 1 Th. 4:14-17)}
...
\TextTitle{[Victoire finale sur la mort]}
...
\TextTitle{[7. Attente de la résurrection]}
...
\TextTitle{[Conclusion : instructions et salutations personnelles]}
\Chap{16}
...
\TextTitle{[Recommandations, exhortations diverses]}
...
\TextTitle{[Anathème contre celui qui n'aime point le Seigneur]}
