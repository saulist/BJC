...
\\Auteur : Paul
\\Date de rédaction : Env. 56 apr. J.-C.\\}
}
%\bigskip
\textit{
...
\TextTitle{[c. Le Seigneur est le seul véritable juge]}
\Chap{4}
...
\TextTitle{[Dieu s'occupe de ses serviteurs]}
...
\VS{6}Car si une femme n'est pas voilée, qu’elle se coupe aussi les cheveux. Or, s'il est honteux pour une femme d'avoir les cheveux coupés, ou d'être rasée, qu'elle se voile.
