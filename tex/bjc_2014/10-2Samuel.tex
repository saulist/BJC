...
\VS{10}Je m’approchai de lui, et je lui donnai la mort\FTNT{Cet homme Amalécite a peut-être menti afin de gagner la faveur de David (1 S. 31:3-5).} sachant bien qu'il ne survivrait pas à sa chute. J'ai enlevé le diadème qu'il avait sur sa tête, et le bracelet qui était à son bras, et je les apporte ici à mon seigneur.
...
\TextTitle{[L'autorité de David s'accroit]
\\(1 Ch. 3:1-4)}
\Chap{3}
...
\TextTitle{[Isch-Boscheth assassiné]}
\Chap{4}
...
\TextTitle{[David oint roi sur tout Israël]
\\(1 Ch. 11:1-3)}
\Chap{5}
...
\TextTitle{[Jérusalem, capitale de tout Israël]
\\(1 Ch. 11:4-9)}
...
\TextTitle{[Fils de David nés à Jérusalem]
\\(2 S. 3:2-5 ; 1 Ch. 3:1-4)}
...
\TextTitle{[Yahweh livre les Philistins à David]
\\(2 S. 23:13-17 ; 1 Ch. 14:8-17 ; 11:15-19 ; 12:8-15)}
...
\TextTitle{[Désobéissance dans le transport de l'arche]
\\(1 Ch. 13:1-14)}
\Chap{6}
...
\TextTitle{[L'arche remise à sa place à Jérusalem]
\\(1 Ch. 15:26-16:1)}
...
\TextTitle{[David veut bâtir une maison à Yahweh]
\\(1 Ch. 17:1-2)}
\Chap{7}
...
\TextTitle{[Yahweh traite alliance avec David]
\\(1 Ch. 17:3-15)}
...
\VS{13}Ce sera lui qui bâtira une maison à mon Nom, et j'affermirai pour toujours le trône de son royaume\FTNT{Le royaume millénaire était promis à David et à sa postérité. Il fut proclamé par Jean-Baptiste (Mt. 3:1-12), le Messie (Mt. 4:17) et les apôtres (Mt. 10) comme étant proche. Présentement, le royaume de Dieu se manifeste par la vie sanctifiée des saints en Christ (Lu. 17:20 ; Jn. 3:1-8 ; Ro. 14:17). Il n’apparaîtra pas de manière visible avant la «moisson», c’est-à-dire le jugement des nations (Mt. 13:39-50). En effet, ce n’est qu’après cette moisson que le royaume sera installé ici-bas, lorsque le Messie rétablira la monarchie et la dynastie de David en sa propre personne. Il rassemblera alors les enfants d’Israël dispersés dans le monde entier et établira sa domination sur toute la terre pendant mille ans. Ce royaume sera remis au Père par le Messie après avoir vaincu le dernier ennemi, c’est-à-dire la mort (1 Co. 15:24-26). De ce fait, personne ne mourra pendant le millénium. Toutes les nations monteront tous les ans à Jérusalem pour adorer Yahweh et célébrer la fête des tabernacles qui sera restaurée (Za. 14). Le gouvernement théocratique en Israël sera alors restauré (Es. 1:26).}.
...
\TextTitle{[Louange et reconnaissance de David envers Yahweh]
\\(1 Ch. 17:16-27)}
...
\TextTitle{[Le royaume de David s'étend]
\\(1 Ch. 18:1-17)}
\Chap{8}
...
\TextTitle{[David et Mephiboscheth]}
\Chap{9}
...
\TextTitle{[Campagnes contres les Ammonites et les Syriens]}
\Chap{10}
...
\TextTitle{[Yahweh envoie Nathan pour reprendre David à cause de son péché]}
\Chap{12}
...
\TextTitle{[Prise de Rabba (1 Ch. 20:1-3)]}
...
\TextTitle{[Conséquences du péché de David]}
\Chap{13}
...
\TextTitle{[Ruse et crime d'Ammon]}
...
\VS{14}Mais il ne voulut pas écouter sa parole ; il fut plus fort qu'elle, lui fit violence et coucha avec elle\FTNT{Le viol et l’inceste que commit Amnon, fils de David, sur Tamar, sa demi-sœur, furent les conséquences du péché de David.}.
...
\TextTitle{[Vengeance d'Absalom sur Ammon]}
...
\TextTitle{[Ruse de Joab pour obtenir le retour d'Absalom]}
\Chap{14}
...
\TextTitle{[David pardonne à Absalom]}
...
\Chap{15}
\VerseOne{}Or il arriva qu’après cela, Absalom se procura des chars et des chevaux, et il avait cinquante hommes qui couraient devant lui\FTNT{La révolte d’Absalom était une autre conséquence du péché de David.}.
...
\TextTitle{[Absalom entre dans Jérusalem]}
...
\TextTitle{[Conseil d'Architophel à Huschaï]}
\Chap{17}
...
\TextTitle{[Absalom poursuit David]}
...
\TextTitle{[Instruction de David pour épargner Absalom]}
\Chap{18}
...
\VS{15}Puis dix jeunes hommes, qui portaient les armes de Joab, entourèrent Absalom, le frappèrent et le firent mourir\FTNT{La mort d’Absalom fut encore une conséquence du péché de David. Le péché a donc des conséquences graves et cause beaucoup de souffrances.}.
...
\TextTitle{[Indignation de Joab sur l'attitude de David]}
\Chap{19}
...
\TextTitle{[David permet la vengeance des Gabaonites]}
\Chap{21}
...
\TextTitle{[Dernières campagnes contre les Philistins]}
...
\VS{3}Le Dieu d'Israël a parlé, le Rocher\FTNT{Le Rocher. Voir Es. 8:13-17. Jésus est notre Rocher.} d'Israël m'a dit : Celui qui règne parmi les hommes avec justice, celui qui règne dans la crainte de Dieu,
...
\TextTitle{[Vaillants hommes de David]
\\(1 Ch. 11:10-47)}
...
\TextTitle{[Nouveau jugement de Yahweh sur Israël infidèle]
\\(1 Ch. 21:1-17)}
\Chap{24}
...
\TextTitle{[Yahweh, le Dieu qui fait miséricorde]
\\(1 Ch. 21:18-30)}
