...
\begin{multicols}{2}
\begin{center}
\textit{[Affection de Paul pour Timothée. Il l'exhorte à la persévérance]}
\end{center}
\Chap{1}
...
\begin{center}
\textit{[Timothée encouragé à poursuivre les travaux de son ministère avec constance et fidélité]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Eviter les disputes de mots, les discours profanes et les questions inutiles]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Prédiction d'une grande corruption de mœurs]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[Exhortation à la fermeté dans la foi. Excellence de l'Ecriture]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Devoirs des pasteurs - Paul annonce sa mort prochaine ]}
\end{center}
\Chap{4}
...
\begin{center}
\textit{[Recommandations diverses - Confiance de l'Apôtre dans le Seigneur]}
\end{center}
\PPE{}
