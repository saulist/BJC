...
\TextTitle{[La sincérité de Paul]}
...
\TextTitle{[La manière d'agir de Paul]}
...
\TextTitle{[Le pardon accordé à un coupable]}
...
\TextTitle{[Le ministère sous la nouvelle alliance
\\1. son effet triomphant}
...
\TextTitle{[2. ses lettres de créance]}
\Chap{3}
...
\TextTitle{[3. sa gloire par l'Esprit]}
...
\TextTitle{[b. Christ doit être prêché, non pas l'homme]}
...
\TextTitle{[c. la puissance doit être atribuée à Dieu saul]
\\(cp. 1 Co. 2:1-5)}
...
\TextTitle{[7. ses motifs d'action]}
...
\TextTitle{[Exemple de la consécration des envoyés des Eglises]}
...
\TextTitle{[Encouragement : aucun don n'est trop grand pour Dieu]}
\Chap{9}
...
\\1. Origine divine de son apostolat}
\Chap{10}
...
\TextTitle{[2. But de l'apostolat]}
\Chap{11}
...
\TextTitle{[3. Avertissements contre les faux docteurs]}
...
\TextTitle{[4. Sujets de gloire de Paul]
\\(2 Co. 11:16-12:18)}
...
\TextTitle{[5. Avertissement de Paul]}
...
\TextTitle{[6. Exhortation aux Corinthiens à s'examiner eux-mêmes]}
\Chap{13}
