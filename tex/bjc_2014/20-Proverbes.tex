...
\VS{7}La crainte de Yahweh (1) est le commencement de la science ; mais les fous méprisent la sagesse et l'instruction.
\VS{8}Mon fils, écoute l'instruction de ton père, et n'abandonne point la loi (2) de ta mère.
...
\VS{16}Pour te délivrer de la femme étrangère (1), et de la femme d'autrui, dont les paroles sont flatteuses ;
...
\VS{2}Car ils prolongeront les jours et les années de ta vie, et ils augmenteront  ta paix (1).
...
\VS{7}Quand Yahweh prend plaisir aux voies d'un homme, il apaise (1) envers lui même ses ennemis.
...
\VS{28}Le témoin pervers (1) se moque de la justice, et la bouche des méchants avale l'iniquité.
...
\VS{6}Les blessures d’un ami sont dignes de confiance, mais les baisers d’un ennemi sont à craindre (1).
...
\VS{9}Celui qui détourne son oreille pour ne pas écouter la loi, sa prière même est une abomination (1).
...
\VS{18}Lorsqu'il n'y a pas de vision (1), le peuple est sans frein, mais heureux est celui qui garde la loi !
...
\VS{4}Lemuel, ce n'est point aux rois, ce n'est point aux rois de boire le vin, ni aux princes de boire la cervoise (1)
