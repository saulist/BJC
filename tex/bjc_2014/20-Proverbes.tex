...
\VS{7}La crainte de Yahweh\FTNT{} est le commencement de la science ; mais les fous méprisent la sagesse et l'instruction.
\VS{8}Mon fils, écoute l'instruction de ton père, et n'abandonne point la loi\FTNT{} de ta mère.
...
\VS{33}Mais celui qui m'écoute habitera en sécurité et sera tranquille, sans crainte aucun mal.
...
\VS{16}Pour te délivrer de la femme étrangère\FTNT{}, et de la femme d'autrui, dont les paroles sont flatteuses ;
...
\VS{2}L'orgueil est-il venu ? Aussi est venu le mépris ; mais la sagesse est avec ceux qui sont humbles.
...
\VS{24}Les paroles agréables sont des rayons de miel, douceur à l'âme, et santé pour le corps.
...
\VS{28}Le témoin pervers\FTNT{} se moque de la justice, et la bouche des méchants avale l'iniquité.
...
\VS{6}Les blessures d’un ami sont dignes de confiance, mais les baisers d’un ennemi sont à craindre\FTNT{}.
...
\VS{9}Celui qui détourne son oreille pour ne pas écouter la loi, sa prière même est une abomination\FTNT{}.
...
\VS{18}Lorsqu'il n'y a pas de vision\FTNT{}, le peuple est sans frein, mais heureux est celui qui garde la loi !
...
\VS{4}Lemuel, ce n'est point aux rois, ce n'est point aux rois de boire le vin, ni aux princes de boire la cervoise\FTNT{}
