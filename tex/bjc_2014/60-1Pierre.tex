...
\end{center}
\Chap{1}
\VerseOne{}Pierre, apôtre de Jésus-Christ, à ceux qui sont étrangers et dispersés dans le Pont (1), la Galatie, la Cappadoce, l’Asie et la Bithynie,
...
\begin{center}
\textit{[De l'espérance vive du chrétien et de l'épreuve de notre foi]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le salut en Christ annoncé par les prophètes]}
\end{center}
\PPE{}
\VS{10}C’est au sujet de ce salut que les prophètes qui ont prophétisé au sujet de la grâce qui vous était destinée, ont fait leurs recherches et leurs investigations.
...
\end{center}
\PPE{}
\VS{13}C’est pourquoi, ceignez les reins de votre entendement, soyez sobres, et ayez une entière espérance dans la grâce qui vous est présentée, jusqu'à ce que Jésus-Christ soit révélé (2).
...
\VS{16}selon ce qu'il est écrit : Soyez saints, car je suis saint (3).
...
\VS{25}mais la parole du Seigneur demeure éternellement (4). Et cette parole est celle qui vous a été annoncée par l’Evangile.
\begin{center}
\textit{[Exhortation à croître en Jésus-Christ]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Exhortation à s'approcher de la pierre angulaire]}
\end{center}
\PPE{}
\VS{6}C'est pourquoi il est dit dans l'Ecriture : Voici, je mets en Sion la principale pierre (1) de l’angle, choisie et précieuse ; et celui qui croit en elle, ne sera point confus.
...
\VS{9}Vous, au contraire, vous êtes la race élue, vous êtes sacrificateurs et rois, la nation sainte, le peuple acquis, afin que vous annonciez les vertus de celui qui vous a appelés des ténèbres à sa merveilleuse lumière,
...
\begin{center}
\textit{[S'abstenir des convoitises charnelles]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Devoirs des serviteurs. Souffrir patiemment à l'exemple de Christ]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Devoirs des femmes et des maris]}
\end{center}
\Chap{3}
...
\VS{7}Et vous, maris, de même conduisez-vous avec prudence envers vos femmes, comme un vase (1) plus fragile, c’est-à-dire, féminin ; honorez-les, comme devant aussi hériter avec vous de la grâce de vie, afin que vos prières ne soient point interrompues.
\begin{center}
\textit{[L'Apôtre recommande à tous de s'aimer, de faire le bien, de chercher la paix, de souffrir avec patience]}
\end{center}
\PPE{}
...
\VS{9}Ne rendez point mal pour mal, ou injure pour injure (2) ; mais au contraire, bénissez ; sachant que c’est à cela que vous êtes appelés, afin d’hériter la bénédiction.
...
\VS{19}par lequel aussi il est allé prêcher aux esprits en prison (3),
...
\begin{center}
\textit{[Exhortation à ne plus vivre selon les convoitises des hommes]}
\end{center}
\Chap{4}
...
\begin{center}
\textit{[Exhortation à vivre dans la sobriété, la vigilance, la prière et la charité]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Consolations pour ceux qui souffrent comme chrétiens]}
\end{center}
\PPE{}
...
\VS{17}Car il est temps que le jugement commence par la maison de Dieu (1). Or s'il commence premièrement par nous, quelle sera la fin de ceux qui n'obéissent pas à l'Evangile de Dieu ?
...
\VS{4}Et lorsque le souverain Pasteur (1) apparaîtra, vous obtiendrez la couronne incorruptible de la gloire.
\begin{center}
\textit{[Devoirs des jeunes gens. L'humilité ; la vigilance et la fermeté dans la foi]}
\end{center}
\PPE{}
