...
\TextTitle{[De l'espérance vive du chrétien et de l'épreuve de notre foi]}
...
\TextTitle{[Le salut en Christ annoncé par les prophètes]}
...
\TextTitle{[Exhortation à croître en Jésus-Christ]}
\Chap{2}
...
\TextTitle{[Exhortation à s'approcher de la pierre angulaire]}
...
\TextTitle{[S'abstenir des convoitises charnelles]}
...
\TextTitle{[Devoirs des serviteurs. Souffrir patiemment à l'exemple de Christ]}
...
\TextTitle{[Devoirs des femmes et des maris]}
\Chap{3}
...
\TextTitle{[L'Apôtre recommande à tous de s'aimer, de faire le bien, de chercher la paix, de souffrir avec patience]}
...
\TextTitle{[Exemple de Jésus-Christ]}
...
\TextTitle{[Exhortation à ne plus vivre selon les convoitises des hommes]}
\Chap{4}
...
\TextTitle{[Exhortation à vivre dans la sobriété, la vigilance, la prière et la charité]}
...
\TextTitle{[Consolations pour ceux qui souffrent comme chrétiens]}
...
\TextTitle{[Devoirs des pasteurs]}
\Chap{5}
...
\TextTitle{[Devoirs des jeunes gens. L'humilité ; la vigilance et la fermeté dans la foi]}
