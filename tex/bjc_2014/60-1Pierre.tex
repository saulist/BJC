...
\VS{8}ils se heurtent contre la parole, et sont rebelles, c’est à cela qu’ils sont destinés.
...
\VS{6}comme Sara, qui obéissait à Abraham et l’appelait son seigneur. C’est d’elle que vous êtes devenues les filles, en faisant ce qui est bien, sans vous laisser troubler par aucune crainte.
...
\VS{6}Car l'Evangile a aussi été annoncé aux morts, afin que, après avoir été jugés comme les hommes dans la chair, ils vivent selon Dieu par l'Esprit.
...
\VS{9}Résistez-lui avec une foi ferme, sachant que les mêmes souffrances sont imposées à vos frères qui sont dans le monde.
