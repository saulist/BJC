...
\begin{multicols}{2}
\begin{center}
\textit{[Affection de l'Apôtre pour les Philippiens]}
\end{center}
\Chap{1}
...
\begin{center}
\textit{[Fruit des afflictions qu'endure l'Apôtre pour l'Evangile]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Christ est sa vie et la mort lui est un gain]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[De l'union, de la charité et de l'humilité à l'exemple de Christ qui s'est anéanti lui-même]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Travailler à son salut avec crainte]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Paul recommande Timothée et Epaphrodite]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Renoncement de Paul à toutes choses pour Jésus-Christ]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[Paul invite les Philippiens à suivre son exemple, comme étant citoyens des cieux]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Exhortations diverses de l'Apôtre]}
\end{center}
\Chap{4}
...
\begin{center}
\textit{[Libéralité des Philippiens - Désintéressement de Paul]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Toutes choses lui sont possibles par Christ]}
\end{center}
\PPE{}
