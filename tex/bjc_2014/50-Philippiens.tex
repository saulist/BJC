...
\begin{multicols}{2}
\TextTitle{[Affection de l'Apôtre pour les Philippiens]}
\Chap{1}
...
\TextTitle{[Fruit des afflictions qu'endure l'Apôtre pour l'Evangile]}
...
\TextTitle{[Exhortation à la persévérance]}
...
\TextTitle{[De l'union, de la charité et de l'humilité à l'exemple de Christ qui s'est anéanti lui-même]}
\Chap{2}
...
\TextTitle{[Travailler à son salut avec crainte]}
...
\TextTitle{[Paul recommande Timothée et Epaphrodite]}
...
\TextTitle{[Renoncement de Paul à toutes choses pour Jésus-Christ]}
\Chap{3}
...
\TextTitle{[Exhortations diverses de l'Apôtre]}
\Chap{4}
...
\TextTitle{[Libéralité des Philippiens - Désintéressement de Paul]}
...
\TextTitle{[Toutes choses lui sont possibles par Christ]}
...
\TextTitle{[Salutations en Christ]}
