...
\begin{multicols}{2}
\TextTitle{[Paul reproche aux Galates de s'être écartés de la pure doctrine de l'Evangile de Jésus-Christ]}
\Chap{1}
...
\TextTitle{[Il leur rappelle la divinité de sa vocation à l'apostolat]}
...
\TextTitle{[La vocation de Paul reconnue par les autres apôtres]}
\Chap{2}
...
\TextTitle{[Justification par la foi et vie de la foi en Christ]}
...
\TextTitle{[L'Apôtre continue à enseigner la justification par la foi et non par la loi]}
\Chap{3}
...
\TextTitle{[La promesse de Dieu faite avant la loi à Abraham]}
...
\TextTitle{[Utilité de la loi pour conduire à Christ]}
...
\TextTitle{[Comparaison de l'état de l'homme sous la loi et sous la grâce]}
\Chap{4}
...
\TextTitle{[Agar et Sara, figure des deux alliances]}
...
\TextTitle{[Demeurer ferme dans la liberté en Christ]}
\Chap{5}
...
\TextTitle{[Usage de la liberté évangélique dans la charité]}
...
\TextTitle{[Les œuvres de la chair opposées au fruit de l'Esprit]}
...
\TextTitle{[Exhortation au support mutuel,]}
\Chap{6}
...
\TextTitle{[Paul ne se glorifie qu'en la croix de Christ]}
