...
\VS{6}Je m'étonne qu'abandonnant Jésus-Christ, qui vous avait appelés par sa grâce, vous ayez été si promptement transportés à un autre évangile. 
\VS{7}Qui n'est pas un autre évangile, mais il y a des gens qui vous troublent, et qui veulent renverser l'Evangile de Christ.
\VS{8}Mais si nous-mêmes vous évangéliserions, ou si un ange du ciel vous évangéliserait, outre\FTNT{Voir 1 R.13.} ce que nous vous avons évangélisé, qu'il soit anathème !
