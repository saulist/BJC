...
\begin{multicols}{2}
\begin{center}
\textit{[Paul reproche aux Galates de s'être écartés de la pure doctrine de l'Evangile de Jésus-Christ]}
\end{center}
\Chap{1}
...
\begin{center}
\textit{[Il leur rappelle la divinité de sa vocation à l'apostolat]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[La vocation de Paul reconnue par les autres apôtres]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Justification par la foi et vie de la foi en Christ]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[L'Apôtre continue à enseigner la justification par la foi et non par la loi]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[La promesse de Dieu faite avant la loi à Abraham]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Utilité de la loi pour conduire à Christ]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Comparaison de l'état de l'homme sous la loi et sous la grâce]}
\end{center}
\Chap{4}
...
\begin{center}
\textit{[Agar et Sara, figure des deux alliances]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Demeurer ferme dans la liberté en Christ]}
\end{center}
\Chap{5}
...
\begin{center}
\textit{[Usage de la liberté évangélique dans la charité]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Les œuvres de la chair opposées au fruit de l'Esprit]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Exhortation au support mutuel,]}
\end{center}
\Chap{6}
...
\begin{center}
\textit{[Paul ne se glorifie qu'en la croix de Christ]}
\end{center}
\PPE{}
