...
\VS{2}O Dieu de ma justice, puisque je crie, réponds-moi ! Quand j’étais à l’étroit, tu m’as mis au large ! Aie pitié de moi, et exauce ma prière\FTNT{Ps. 28:1-2.} !
...
\VS{3}Par la bouche des enfants et de ceux qui tètent\FTNT{Mt. 21 : 16.}, tu as fondé ta puissance, à cause de tes adversaires, afin de faire cesser l'ennemi et le vindicatif.
...
\VS{15}afin que je raconte toutes tes louanges, dans les portes de la fille de Sion, et que je me réjouisse de ton salut\FTNT{Voir commentaire en Es. 26:1.}.
...
\VS{2}Yahweh regarde des cieux les fils de l’homme, pour voir s'il y en a quelqu'un qui soit intelligent, qui cherche Dieu\FTNT{Ps. 33:13 ; Job. 28:24.}.
...
\VS{3}Yahweh est mon rocher\FTNT{Yahweh est le rocher sur lequel s’appuyait David. Paul enseigne que ce rocher était Jésus-Christ (1 Co. 10:1-4). Voir commentaire Es. 8:13-17.}, ma forteresse, et mon libérateur ! Mon Dieu puissant, mon rocher où je trouve un refuge ! Mon bouclier, la force qui me sauve, ma haute retraite !
...
\VS{32}Car qui est Dieu, si ce n’est Yahweh ? Et qui est un rocher, si ce n’est notre Dieu ? \FTNT{}
\VS{33}C'est le Dieu puissant qui me ceint de force, et qui me conduit dans la voie droite.
\VS{34}Il rend mes pieds semblables à ceux des biches \FTNT{}, et il me place sur mes lieux élevés.
\VS{35}Il exerce mes mains au combat, et mes bras tendent l’arc d’airain \FTNT{}.
...
\VS{26}Tu seras l’objet de mes louanges dans la grande assemblée ; j’accomplirai mes vœux en présence de ceux qui te craignent \FTNT{}.
\VS{27}Les malheureux mangeront et seront rassasiés ; ceux qui cherchent Yahweh le loueront, votre cœur vivra à perpétuité !
\VS{28}Toutes les extrémités de la terre s'en souviendront, ils se convertiront à Yahweh, et toutes les familles des nations se prosterneront devant toi \FTNT{}.
...
\VS{31}La postérité le servira, on parlera du Seigneur de génération en génération \FTNT{}.
...
\VS{24}Afin que tu plonges ton pied dans le sang \FTNT{}, et que la langue de tes chiens ait sa part de tes ennemis.
\VS{25}Ils voient ta marche, ô Dieu ! Ils ont vu ta marche dans le lieu saint, la marche de mon Dieu puissant, mon roi.
\VS{26}Les chantres allaient devant, ensuite les joueurs d'instruments, et au milieu les jeunes filles jouant du tambour \FTNT{}.
...
\VS{30}Dans ton temple, à Jérusalem, les rois t'amèneront des présents \FTNT{}.
...
\VS{32}Malgré cela, ils péchèrent encore et ne crurent point à ses prodiges \FTNT{}.
...
\VS{36}Mais ils le trompaient de leur bouche et ils lui mentaient de leur langue \FTNT{} ;
...
\VS{44}Il changea leurs fleuves en sang, et ils ne purent en boire les eaux \FTNT{}.
\VS{45}Il envoya contre eux des mouches qui les dévorèrent et des grenouilles qui les détruisirent \FTNT{}.
\VS{46}Il livra leurs récoltes aux sauterelles, le produit de leur travail aux sauterelles \FTNT{}.
\VS{47}Il détruisit leurs vignes par la grêle, et leurs sycomores par les orages \FTNT{}.
...
\VS{50}Il donna libre cours à sa colère, et ne retira point leur âme de la mort ; il livra leur vie à la mortalité \FTNT{}.
\VS{51}Il frappa tout premier-né en Egypte, les prémices de la vigueur dans les tentes de Cham \FTNT{}.
...
\VS{54}Il les amena vers sa frontière sainte, vers cette montagne que sa droite a conquise \FTNT{}.
...
\VS{58}Ils le provoquèrent à la colère par leurs hauts lieux, et l’émurent à la jalousie par leurs images taillées \FTNT{}.
...
\VS{70}Il choisit David, son serviteur, et le prit de la bergerie \FTNT{} ;
...
\VS{13}Comme un père a compassion de ses fils, Yahweh a compassion de ceux qui le craignent \FTNT{}.
...
\VS{18}pour ceux qui gardent son alliance, et qui se souviennent de ses commandements pour les faire \FTNT{}.
...
\VS{26}Il envoya Moïse son serviteur, et Aaron, qu'il avait élu \FTNT{}.
...
\VS{36}Il frappa tous les premiers-nés du pays, les prémices de toute leur vigueur \FTNT{}.
...
\VS{40}Le peuple demanda et il fit venir des cailles ; et il les rassasia du pain des cieux \FTNT{}.
\VS{41}Il ouvrit le rocher et les eaux en coulèrent ; elles se répandirent comme un fleuve dans les lieux arides \FTNT{}.
\VS{42}Car il se souvint de sa parole sainte qu’il avait donnée à Abraham son serviteur \FTNT{}.
\VS{43}Il fit sortir son peuple dans l’allégresse, ses élus au milieu des cris retentissants \FTNT{}.
...
\VS{37}Car ils sacrifièrent leurs fils et leurs filles aux démons \FTNT{}.
\VS{38}Ils répandirent le sang innocent, le sang de leurs fils et de leurs filles, ils sacrifièrent aux faux dieux de Canaan ; et le pays fut souillé de sang \FTNT{}.
