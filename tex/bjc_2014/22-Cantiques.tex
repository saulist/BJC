...
\begin{multicols}{2}
\TextTitle{[La fiancée exprime ici son amour pour son fiancé, et le fiancé son amour pour sa fiancée.]}
\Chap{1}
...
\TextTitle{[Discours de l'Eglise par rapport au Messie.]}
\Chap{2}
...
\TextTitle{[La recherche que l'Eglise fait du messie et sa joie de l'avoir trouvé.]}
\Chap{3}
...
\TextTitle{[Beauté de la fiancée, décrite spirituellement et par des expressions figurées.]}
\Chap{4}
...
\TextTitle{[Regret de la fiancée de ne pas avoir répondu comme elle devait à la recherche de son fiancé,
elle décrit la beauté du fiancé.]}
\Chap{5}
...
\TextTitle{[Dialogue entre le fiancé et la fiancée.]}
\Chap{6}
...
\TextTitle{[Autre description mystérieuse de la beauté de la fiancée ; Amour fidèle de l'Eglise pour le messie.]}
\Chap{7}
...
\TextTitle{[Amour réciproque de l'Eglise pour le messie, et du messie pour l'Eglise.]}
\Chap{8}
