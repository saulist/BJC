...
\par\nobreak\noindent\hrulefill
\begin{multicols}{2}
\TextTitle{[La vision de la gloire de Yahweh]}
\Chap{1}
...
\TextTitle{[La parole de Yahweh affermit Ezéchiel]}
\Chap{3}
...
\TextTitle{[Signes prophétiques sur le jugement de Jérusalem]
\\1 - La brique et la poêle de fer}
\Chap{4}
...
\TextTitle{[3 - Le rasoir et les cheveux]}
\Chap{5}
...
\TextTitle{[Le reste d'Israël épargné par Yahweh]}
\Chap{6}
...
\TextTitle{[Auteurs d'abominations frappés]}
...
\TextTitle{[Siège et invasion babyloniennes imminents]}
\Chap{7}
...
\TextTitle{[Profanation du temple]}
...
\TextTitle{[La marque de Yahweh sur les justes]}
\Chap{9}
...
\TextTitle{[La gloire de Dieu quitte le temple de Jérusalem]}
\Chap{10}
...
\TextTitle{[Le jugement de Dieu sur les impies]}
\Chap{11}
...
\TextTitle{[Restauration du reste d'Israël]}
...
\TextTitle{[imminence de la captivité]
\\(cp. 2 R. 25:1-10)}
...
\TextTitle{[Yahweh cherche des justes au milieu du peuple]}
...
\TextTitle{[Israël infidèle à Yahweh]
\\(cp. Es. 5:1-24)}
\Chap{15}
\VerseOne{}La parole de Yahweh me fut encore adressée, en disant :
...
\TextTitle{[Yahweh dénonce l'infidélité de Jérusalem]}
\Chap{16}
...
\TextTitle{[Fidélité et miséricorde de Dieu]}
...
\TextTitle{[Parabole des deux aigles]}
\Chap{17}
...
\TextTitle{[Jugement de Dieu sur Sédécias]
\\(2 R. 24:17-20 ; 25:1-10)}
...
\TextTitle{[Parabole de la lionne et ses lionceaux]}
\Chap{19}
...
\TextTitle{[Yahweh rappelle sa fidélité à son peuple]}
\Chap{20}
...
\TextTitle{[Yahweh confirme la future restauration d'Israël]}
...
\TextTitle{[Le peuple méprise le message de Dieu]}
\Chap{21}
\VerseOne{}La parole de Yahweh me fut encore adressée en ces mots :
...
\TextTitle{[Quand l'iniquité arrive à son terme]
\\(v. 31-32 ; Ap. 19:11-20:6)}
...
\TextTitle{[Parabole des scories dans la fournaise]}
\VS{17}Puis la parole de Yahweh me fut adressée en ces mots :
...
\TextTitle{[Parabole sur Israël et Juda]}
\Chap{23}
\VerseOne{}La parole de Yahweh me fut encore adressée en ces mots :
...
\TextTitle{[Parabole de la chaudière bouillante]}
\Chap{24}
...
\TextTitle{[Orgueil du prince de Tyr]}
\Chap{28}
\VerseOne{}La parole de Yahweh me fut encore adressée en ces mots :
...
\TextTitle{[Chute du roi de Tyr représentant satan]
\\(cp. Es. 14:12-17)}
...
\TextTitle{[Chute furure de l'Egypte]}
\Chap{30}
\VerseOne{}La parole de Yahweh me fut encore adressée en ces mots :
...
\TextTitle{[Parabole du cèdre du Liban]}
\Chap{31}
...
\TextTitle{[Complainte sur Pharaon et l'Egypte]}
\Chap{32}
...
\TextTitle{[Responsabilité de la sentinelle: avertir le peuple]}
\Chap{33}
\VerseOne{}La parole de Yahweh me fut encore adressée en ces mots :
...
\TextTitle{[Yahweh, le bon berger qui restaure son troupeau]}
...
\TextTitle{[Vallée des ossements desséchés: Rétablissement d'Israël]}
\Chap{37}
...
\TextTitle{[Destruction des envahisseurs]}
\Chap{39}
...
\TextTitle{[Restauration et conversion d'Israël]}
...
\TextTitle{[Mesures complémentaires du temple]}
\Chap{42}
...
\TextTitle{[La gloire de Yahweh remplit le temple]
\\(cp. Ez. 11:22-24)}
\Chap{43}
...
\TextTitle{[L'autel des sacrifices]}
...
\VS{20}Tu prendras de son sang, le mettras sur les quatre cornes de l'autel, et sur les quatre angles de l’encadrement et sur le rebord qui l’entoure, ainsi tu purifieras l'autel, et tu en feras l’expiation pour lui\FTNT{Ex. 29:36-39.}.
...
\TextTitle{[Territoire réservé à Yahweh]}
\Chap{45}
...
\TextTitle{[Territoire réservé au prince]}
...
\TextTitle{[Le peuple  entraîné dans l'adoration de Yahweh]}
\Chap{46}
...
\TextTitle{[Plénitude de la gloire de Dieu]
\\(cp. Za. 14:8-9 ; Ap. 22:1-2)}
\Chap{47}
...
\TextTitle{[Délimitations du pays]
\\(cp. Ge. 15:18-21)}
...
\TextTitle{[Héritage de sept tribus dans le pays]
\\(cp. Jos. 13:1-19:51)}
\Chap{48}
...
\TextTitle{[Territoire réservé aux sacrificateurs et lévites]}
...
\TextTitle{[Cinq tribus reçoivent leur héritage]}
\VS{23}Quant au reste des tribus, depuis le côté de l’orient jusqu'au côté de l’occident, Benjamin aura une portion.
\VS{24}Et sur la frontière de Benjamin, depuis le côté de l’orient jusqu'au côté de l’occident, il y aura une autre portion pour Siméon.
\VS{25}Et sur la frontière de Siméon, depuis le côté de l’orient jusqu'au côté de l’occident, il y aura une autre portion pour Issacar.
\VS{26}Et sur la frontière d’Issacar, depuis le côté de l’orient jusqu'au côté de l’occident, il y aura une autre portion pour Zabulon.
\VS{27}Et sur la frontière de Zabulon, depuis le côté de l’orient jusqu'au côté de l’occident, il y aura une autre portion pour Gad.
\VS{28}Et sur la frontière de Gad du côté sud, au midi, la frontière sera depuis Thamar jusqu'aux eaux de contestation, à Kadès, jusqu'à la rivière vers la grande mer.
