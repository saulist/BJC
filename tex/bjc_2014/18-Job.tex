...
\Chap{1}
\VerseOne{}Il y avait dans le pays d'Uts (1) un homme dont le nom était Job (2). Cet homme était intègre (3) et droit, craignant (4) Dieu et se détournant du mal.
\VS{2}Il lui naquit sept fils et trois filles.
\VS{3}Et son bétail était de sept mille brebis, trois mille chameaux, cinq cents paires de bœufs, cinq cents ânesses, et un très grand nombre de serviteurs (5). Et cet homme était le plus grand de tous les fils de l'orient.
...
\VS{5}Quand les jours de festin étaient passés, Job envoyait chercher ses fils pour les sanctifier, et se levant de bon matin, il offrait un holocauste selon le nombre de ses enfants ; car Job disait : Peut-être mes fils ont-ils péché, et ont-ils blasphémé contre Dieu dans leurs cœurs. Job faisait toujours ainsi. (6)
\VS{6}Or, il arriva un jour que les fils de Dieu (7) vinrent un jour se présenter devant Yahweh, et Satan (8) aussi vint au milieu d’eux.
\VS{7}Yahweh dit à Satan : D'où viens-tu ? Et Satan répondit à Yahweh : De courir çà et là sur la terre et de m'y promener (9).
...
\Chap{2}
\VerseOne{}Or il arriva un jour  que les fils de Dieu vinrent un jour se présenter devant Yahweh, Satan (1) vint aussi au milieu d'eux se présenter devant Yahweh.
\VS{2}Yahweh dit à Satan : D'où viens-tu ? Satan répondit à Yahweh : De courir çà et là sur la terre et de m'y promener.
\VS{3}Yahweh dit à Satan: N'as-tu point considéré mon serviteur Job, qui n'a point d'égal sur la terre ; homme sincère et droit, craignant Dieu, et se détournant du mal ? Il demeure ferme dans son intégrité, quoique tu m'aies incité contre lui à le détruire sans cause (2).
\VS{4}Satan répondit à Yahweh : Peau pour peau ! Tout ce que possède un homme, il le donne pour sa vie.
\VS{5}Mais étends ta main, et touche à ses os et à sa chair (3), et je suis sûr qu'il te maudit en face !
...
\VS{8}Job prit un tesson pour se gratter et s'assit au milieu de la cendre (4).
\TextTitle{[Réaction de Job et de sa femme]}
\VS{9}Sa femme lui dit : Tu demeures ferme dans ton intégrité ! Bénis (5) Dieu, et meurs !
\VS{10}Et il lui dit : Tu parles comme une femme insensée ! Nous recevons le bien de la part de Dieu, et nous ne recevrions pas le mal ! (6) En tout cela, Job ne pécha pas par ses lèvres.
...
\Chap{3}
\VerseOne{}Après cela, Job ouvrit la bouche et maudit le jour de sa naissance. (1)
...
\VS{5}Que les ténèbres et l'ombre de la mort (2) s'en emparent, que des nuées établissent leur demeure sur lui, et que des obscurités le terrifient !
...
\VS{9}Que les étoiles de son crépuscule soient obscurcies, qu'elle attende en vain la lumière, et qu'elle ne voie pas les paupières de l'aurore (3) !
\VS{10}Parce qu'elle n'a pas fermé le sein qui me conçut ni caché la souffrance à mes yeux.
\VS{11}Pourquoi ne suis-je pas mort dans le sein de ma mère ? Pourquoi n'ai-je pas expiré au sortir de ses entrailles ? (4)
\VS{12}Pourquoi ai-je trouvé des genoux pour me recevoir, et des mamelles pour m'allaiter ?
\VS{13}Je serais couché maintenant, je serais tranquille, je dormirais, je me reposerais (5),
...
\VS{16}Ou je n'existerais pas, je serais comme un avorton caché (6), comme les petits enfants qui n'ont pas vu la lumière.
...
\VS{21}qui espèrent en vain la mort, et qui la recherchent plus qu'un trésor, (7)
\VS{22}qui seraient contents jusqu'à l'allégresse et ravis de joie s'ils trouvaient le tombeau ?
\VS{23}A l'homme qui ne sait où aller et que Dieu cerne de toutes parts ? (8)
...
\VS{3}Voici, tu as souvent instruit les autres, et tu as fortifié les mains affaiblies (1),
\VS{4}tes paroles ont relevé ceux qui chancelaient, et tu as affermi les genoux qui pliaient (2).
...
\VS{7}Cherche dans ton souvenir : Quel est l'innocent qui a péri ? Quels sont les justes qui ont été exterminés ? (3)
\VS{8}J'ai vu que ceux qui labourent l'iniquité et qui sèment la peine en moissonnent les fruits ; (4)
\VS{9}ils périssent par le souffle de Dieu, et ils sont consumés par le vent de ses narines. (5)
...
\VS{13}Au moment où les visions de la nuit agitent la pensée, quand un profond sommeil tombe sur les hommes (6),
...
\VS{17}L'homme serait-il juste devant Dieu ? L'homme serait-il pur devant celui qui l'a fait ? (7)
\VS{18}Si Dieu n'a pas confiance en ses serviteurs, s'il trouve de la folie chez ses anges, (8)
\VS{19}combien plus chez ceux qui habitent des maisons d'argile, qui ont leurs fondements dans la poussière, qu'on écrase comme des vermisseaux ! (9)
...
\Chap{5}
\VerseOne{}Crie maintenant ! Y aura-t-il quelqu'un qui te réponde ? Et vers quel saint te tourneras-tu ? (1)
\VS{2}La colère tue l'insensé, et le fou meurt dans ses emportements.
\VS{3}J'ai vu l'insensé prendre racine (2) ; mais soudain, j'ai maudit sa demeure.
\VS{4}Ses fils sont loin de tout secours ; ils sont écrasés à la porte, et personne ne les délivre ! (3)
...
\VS{7}l'homme nait pour la peine (4), comme l'étincelle pour voler et s'élever.
\VS{8}Mais moi, j'aurais recours à Dieu, et j'adresserais ma parole à Dieu.
\VS{9}Il fait de grandes choses qu'on ne peut sonder, de merveilleuses choses qu'on ne peut compter (5).
\VS{10}Il répand la pluie sur la terre, et envoie les eaux sur les campagnes (6) ;
\VS{11}il met en haut ceux qui sont abaissés, et délivre les affligés (7) ;
\VS{12}il anéantit les projets des hommes rusés, et leurs mains ne peuvent les accomplir (8) ;
\VS{13}il prend les sages dans leurs propres ruses (9), et les desseins des hommes pervers sont renversés :
...
\VS{3}elles seraient plus pesantes que le sable de la mer ; voilà pourquoi mes paroles vont jusqu'à la folie (1) !
\VS{4}Car les flèches du Tout-Puissant sont sur moi, mon âme en boit le venin ; les terreurs (2) de Dieu se rangent en bataille contre moi (3).
\VS{5}L'âne sauvage (4) crie-t-il auprès de l'herbe ? Le bœuf mugit-il auprès de son fourrage ?
...
\VS{9}Qu'il plaise à Dieu de m'écraser, qu'il étende sa main pour m'achever ! (5)
...
\VS{14}Celui qui souffre a droit à la compassion de son ami, même quand il abandonnerait la crainte (6) du Tout-Puissant (7).
\VS{15}Mes frères m'ont trompé comme un torrent, comme le lit des torrents qui passent (8).
...
\VS{19}Les caravanes de Théma (9) fixent le regard, les voyageurs de Séba (10) s’attendent à eux ;
...
\VS{2}Comme un esclave, il soupire après l'ombre, comme un mercenaire (1), il attend son salaire (2).
\VS{3}Ainsi j'ai reçu en partage des mois en vain, et l'on m'a assigné des nuits de peine (3).
\VS{4}Je me couche et je dis : Quand me lèverai-je ? Quand finira la nuit ? Et je suis rassasié d'agitations jusqu'au point du jour (4).
\VS{5}Ma chair se couvre de vers et d'une croûte terreuse, ma peau se crevasse et coule.
\VS{6}Mes jours sont plus rapides que la navette du tisserand, ils se consument sans espoir ! (5)
\VS{7}Souviens-toi que ma vie est un souffle ! Et que mes yeux ne reverront plus le bonheur (6).
\VS{8}L'œil qui me regarde ne me verra plus ; ton œil me cherchera, et je ne serai plus.
\VS{9}La nuée se dissipe et s'en va, ainsi celui qui descend au scheol (7) ne remontera pas (8);
\VS{10}il ne reviendra plus dans sa maison, et le lieu qu'il habitait  ne le reconnaîtra plus (9).
...
\VS{2}Jusqu'à quand parleras-tu ainsi, et les paroles de ta bouche seront-elles un vent impétueux ? (1)
\VS{3}Dieu renverserait-il le droit ? Le Tout-Puissant renverserait-il la justice (2) ? (3)
\VS{4}Si tes fils ont péché contre lui, il les a livrés à leur crime.
\VS{5}Mais toi si tu cherches Dieu, si tu demandes grâce au Tout-Puissant ; (4)
\VS{6}si tu es pur et droit, il veillera certainement sur toi, il rendra le bonheur à la demeure de ta justice ;
\VS{7}tes commencements (5) auront été peu de chose, et ta fin sera bien plus grande. (6)
\VS{8}Interroge ceux des générations précédentes, applique-toi à l'expérience de leurs pères. (7)
\VS{9}Car nous sommes d'hier, et nous ne savons rien, car nos jours sur la terre ne sont qu'une ombre. (8)
...
\VS{12}Encore vert et sans qu'on le coupe, il sèche plus vite que toutes les herbes. (9)
...
\Chap{9}
\VerseOne{}Job prit la parole et dit :
\VS{2}Certainement, je sais qu'il en est ainsi ; et comment l'homme serait-il juste (1) devant Dieu ? (2)
\VS{3}S'il voulait contester avec lui, sur mille choses il ne pourrait répondre à une seule. (3)
\VS{4}A lui la sagesse et la toute-puissance : Qui lui résisterait impunément ? (4)
\VS{5}Il transporte les montagnes, il les renverse dans sa fureur. (5)
\VS{6}Il fait trembler la terre sur sa base, et ses colonnes sont ébranlées. (6)
\VS{7}Il commande au soleil, et le soleil ne se lève pas ; et il met un sceau sur les étoiles. (7)
\VS{8}Seul, il étend les cieux (8), il marche sur les hauteurs de la mer (9).
...
\VS{19}Déjà maintenant, mon témoin est dans le ciel, mon témoin est dans les lieux élevés (1).
...
\VS{19}Mon sein est comme un vin sans issue, comme des outres neuves qui vont éclater (1).
...
\VS{10}Voici le béhémoth (1), que j'ai façonné comme toi ! Il mange de l'herbe comme le bœuf.
...
\VS{20}Attireras-tu le léviathan (2) à l'hameçon ? Saisiras-tu sa langue avec une corde ?
