...
\VS{20}Mais comme il y pensait, voici, l'Ange du Seigneur{\FTNT{L’ange du Seigneur c’est l’ange de Yahweh, c’est-à-dire Jésus-Christ lui-même (Ge. 16:7). Tous les commentateurs bibliques s’accordent pour dire que l’ange de Yahweh c’est Jésus-Christ avant son incarnation. Sur ce point, ils ont raison en partie dans la mesure où l’ange de Yahweh est bel et bien Jésus-Christ. Toutefois, il n’a pas cessé de se manifester sous cette forme après son incarnation. En effet, dans les passages suivants : Mt. 3:3 ; Mt. 4:10 ; Mt. 21:9 ; Mc.12:29 ; Lu. 1:68 ; Lu. 2:9, Ro. 10:13, on cite respectivement les prophéties de : Es. 40:3 ; De. 6:16 ; De. 6:13 ; Ps. 118:26 ; De. 6:5 ; 1 R. 1:48 ; Ps. 106:48 ; Joë. 2:32. Tous ces passages des évangiles et des épîtres, qui sont censés être des citations textuelles des écrits prophétiques, ont été mal traduits. Au lieu de conserver le tétragramme YHWH (Yahweh), les traducteurs l’ont remplacé par le terme grec « kurios », ce qui veut dire « Seigneur » en français. Cette mauvaise traduction a contribué à propager l’erreur selon laquelle l’ange de Yahweh aurait cessé de se manifester après l’incarnation de Jésus. Or en Mt. 1:20, l’ange de Yahweh, donc Jésus-Christ lui-même, est apparu à Joseph alors qu’il se trouvait en même temps dans le ventre de Marie ! Ce même ange s’était adressé à Manoach et sa femme pour leur annoncer la naissance de Samson (Jg. 13). Nous avons ici une preuve merveilleuse de la toute-puissance et de l’omniprésence de notre Dieu qui peut se manifester sous diverses formes, à plusieurs endroits et en même temps, sans l’aide de personne.}} lui apparut en songe et lui dit : Joseph, fils de David, ne crains point de prendre avec toi Marie, ta femme, car l’enfant qu’elle a conçu est du Saint-Esprit.
...
\begin{center}
\textit{[Les mages d'Orient et Hérode]}
\end{center}
\Chap{2}
...
\VS{6}Et toi, Bethléem, terre de Juda, tu n'es certes pas la plus petite entre les principales villes de Juda, car de toi sortira le chef qui paîtra mon peuple d'Israël (1).
...
\VS{9}Après avoir entendu le roi, ils partirent. Et voici, l'étoile (2) qu'ils avaient vue en Orient allait devant eux, jusqu’au moment où, arrivée au-dessus du lieu où était le petit enfant, elle s’arrêta.
...
\VS{15}Il y resta là jusqu’à la mort d'Hérode ; afin que s’accomplisse ce que le Seigneur avait annoncé par le prophète : J'ai appelé mon Fils hors d'Egypte (3).
\begin{center}
\textit{[Massacre des enfants]}
\end{center}
\PPE{}
...
\VS{18}On a entendu à Rama des cris, des lamentations, des plaintes, et des grands gémissements : Rachel pleure ses enfants, et n’a pas voulu être consolée, parce qu’ils ne sont plus (4).
...
\VS{23}et vint habiter dans la ville appelée Nazareth ; afin que s’accomplisse ce qui avait été dit par les prophètes : Il sera appelé Nazaréen (5).
\begin{center}
\textit{[Ministère de Jean-Baptiste]}
\end{center}
\Chap{3}
...
\VS{11}Pour moi, je vous baptise d'eau en signe de repentance ; mais celui qui vient après moi est plus puissant que moi, et je ne suis pas digne de porter ses souliers ; celui-là vous baptisera du Saint-Esprit et de feu (1).
...
\begin{center}
\textit{[Jean baptise Jésus-Christ]}
\end{center}
\PPE{}
...
\VS{4}Mais Jésus répondit et dit : Il est écrit : L'homme ne vivra point de pain seulement, mais de toute parole qui sort de la bouche de Dieu (1).
\VS{5}Alors le diable le transporta dans la sainte ville et le mit sur le haut du temple ;
\VS{6}et il lui dit : Si tu es le Fils de Dieu, jette-toi en bas ; car il est écrit : Il ordonnera à ses anges de te porter sur leurs mains, de peur que ton pied ne heurte contre une pierre (2).
\VS{7}Jésus lui dit : Il est aussi écrit : Tu ne tenteras point le Seigneur ton Dieu (3).
...
\VS{10}Mais Jésus lui dit : Retire-toi Satan ! Car il est écrit : Tu adoreras le Seigneur ton Dieu, et tu le serviras lui seul (4).
\VS{11}Alors le diable le laissa. Et voici, des anges s'approchèrent et le servirent.
\begin{center}
\textit{[Jésus commence son ministère en Galilée]}
\end{center}
\PPE{}
...
\VS{16}Ce peuple, assis dans les ténèbres, a vu une grande lumière ; et à ceux qui étaient assis dans la région et l'ombre de la mort, la lumière elle-même s'est levée (5).
\VS{17}Dès lors, Jésus commença à prêcher et à dire : Repentez-vous, car le Royaume des cieux est proche.
\begin{center}
\textit{[Appel de Pierre, André, Jacques et Jean]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[L'enseignement de Jésus sur la montagne]}
\end{center}
\Chap{5}
...
\VS{22}Mais moi je vous dis que quiconque se met en colère sans cause contre son frère sera puni par les juges ; et celui qui dira à son frère : Raca ! sera puni par le conseil ; et celui qui lui dira : Insensé ! sera puni par le feu de la géhenne (1).
...
\begin{center}
\textit{[Jésus condamne l'hypocrisie]}
\end{center}
\Chap{6}
...
\begin{center}
\textit{[Jésus exhorte ses disciples à chercher d'abord le Royaume de Dieu]}
\end{center}
\PPE{}
...
\VS{24}Nul ne peut servir deux maîtres. Car, ou il haïra l'un, et aimera l'autre ; ou il s'attachera à l'un, et méprisera l'autre. Vous ne pouvez pas servir Dieu et Mammon (1).
...
\begin{center}
\textit{[Fin du discours de Jésus-Christ]}
\end{center}
\Chap{7}
...
\VS{25}La pluie est tombée, les torrents sont venus, les vents ont soufflé contre cette maison : Elle n'est point tombée, parce qu'elle était fondée sur le roc (1).
...
\VS{2}Et voici, un lépreux vint et se prosterna devant lui, en lui disant : Seigneur (1), si tu veux, tu peux me rendre pur.
...
\begin{center}
\textit{[Guérison de la belle-mère de Pierre]}
\end{center}
\PPE{}
...
\VS{17}afin que s’accomplisse ce qui avait été annoncé par Esaïe le prophète, en disant : Il a pris nos faiblesses et a porté nos maladies (2).
...
\begin{center}
\textit{[Guérison de deux démoniaques gadaréniens]}
\end{center}
\PPE{}
...
\VS{13}Mais allez et apprenez ce que veulent dire ces paroles : Je prends plaisir à la miséricorde, et non aux sacrifices (1). Car je ne suis pas venu appeler à la repentance les justes, mais les pécheurs.
...
\begin{center}
\textit{[Résurrection de la fille de Jaïrus et guérison de divers malades]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[La mission des douze apôtres]}
\end{center}
\Chap{10}
...
\VS{8}Guérissez les malades, purifiez les lépreux, ressuscitez les morts, chassez les démons. Vous avez reçu gratuitement, donnez gratuitement (1).
...
\begin{center}
\textit{[Réponse de Jésus-Christ aux disciples de Jean-Baptiste]}
\end{center}
\Chap{11}
...
\VS{5}Les aveugles recouvrent la vue, les boiteux marchent, les lépreux sont purifiés, les sourds entendent, les morts sont ressuscités, et l'Evangile est annoncé aux pauvres (1).
\VS{6}Mais, heureux celui pour qui je ne serai pas une occasion de chute !
\begin{center}
\textit{[Jésus témoigne de Jean-Baptiste]}
\end{center}
\PPE{}
...
\VS{10}Car c’est celui dont il est écrit : Voici, j'envoie mon messager (2) devant ta face, pour préparer ton chemin devant toi.
...
\VS{14}Et si vous voulez recevoir mes paroles, c'est lui qui est l'Elie (3) qui devait venir.
...
\begin{center}
\textit{[Reproches aux villes qui ne s'étaient pas converties]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus est le maître du sabbat]}
\end{center}
\Chap{12}
...
\VS{7}Si vous saviez ce que signifient ces paroles : Je prends plaisir à la miséricorde, et non aux sacrifices, vous n'auriez pas condamné des innocents (1).
\VS{8}Car le Fils de l'homme est Maître du sabbat.
\begin{center}
\textit{[L'homme à la main sèche]}
\end{center}
\PPE{}
...
\VS{21}Et les nations espéreront en son nom (2).
\begin{center}
...
\begin{center}
\textit{[Blasphème contre le Saint-Esprit]}
\end{center}
\PPE{}
...
\VS{32}Quiconque parlera contre le Fils de l'homme, il lui sera pardonné ; mais quiconque parlera contre le Saint-Esprit, il ne lui sera pardonné ni dans ce siècle, ni dans le siècle à venir (3).
...
\begin{center}
\textit{[Jésus refuse d'accomplir un miracle]}
\end{center}
\PPE{}
...
\VS{15}Car le cœur de ce peuple est engraissé, et ils ont endurci leurs oreilles, et ils ont fermé leurs yeux, de peur qu'ils ne voient de leurs yeux, qu'ils n'entendent de leurs oreilles, qu'ils ne comprennent de leur cœur, qu’ils ne se convertissent, et que je ne les guérisse (1).
...
\VS{23}Mais celui qui a reçu la semence dans la bonne terre, c'est celui qui entend la parole et la comprend. Il porte du fruit, et un grain donne cent, un autre soixante, et un autre trente (2).
\begin{center}
\textit{[Parabole du blé et de l'ivraie]}
\end{center}
\PPE{}
\VS{24}Il leur proposa une autre parabole et il dit (3) : Le Royaume des cieux est semblable à un homme qui a semé de la bonne semence dans son champ.
...
\VS{35}afin que s’accomplisse ce qui avait été annoncé par le prophète : J'ouvrirai ma bouche en paraboles, je déclarerai les choses qui ont été cachées dès la fondation du monde (4).
...
\begin{center}
\textit{[Parabole du trésor caché, de la perle et du filet]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus marche sur les eaux]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus-Christ condamne les traditions]}
\end{center}
\Chap{15}
...
\VS{9}C’est en vain qu’ils m'honorent, en enseignant des doctrines qui ne sont que des commandements d'hommes (1).
...
\begin{center}
\textit{[Jésus-Christ refuse de faire un miracle]}
\end{center}
\Chap{16}
...
\VS{18}Et moi je te dis, que tu es Pierre, et que sur ce Roc (1) je bâtirai mon Eglise ; et les portes de l’enfer (2) ne prévaudront point contre elle.
\VS{19}Je te donnerai les clefs du Royaume des cieux ; et tout ce que tu lieras sur la terre, sera lié dans les cieux ; et tout ce que tu délieras sur la terre, sera délié dans les cieux (3).
\VS{20}Alors il recommanda expressément à ses disciples de ne dire à personne qu’il était le Christ.
\begin{center}
\textit{[Jésus prédit sa mort]}
\end{center}
\PPE{}
...
\VS{28}Je vous le dis en vérité, quelques-uns de ceux qui sont ici présents, ne mourront point, qu’ils n’aient vu le Fils de l'homme venir dans son règne (4).
\begin{center}
\textit{[Transfiguration de Jésus-Christ]}
\end{center}
\Chap{17}
...
\begin{center}
\textit{[Jésus guérit un lunatique]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus paye les deux drachmes]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[L'humilité, secret de la vraie grandeur (Mc.9:33-37; Lu.9:46-48)]}
\end{center}
\Chap{18}
...
\begin{center}
\textit{[Parabole de la brebis égarée]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Discipline dans les assemblées]}
\end{center}
\PPE{}
\VS{15}Si ton frère a péché contre toi, va, et reprends-le entre toi et lui seul. S’il t'écoute, tu as gagné ton frère.
\VS{16}Mais s'il ne t'écoute pas, prends encore avec toi une ou deux personnes, afin que toute l’affaire se règle sur la déclaration de deux ou de trois témoins (1).
...
\VS{18}Je vous le dis en vérité, tout ce que vous lierez sur la terre, sera lié dans le ciel ; et tout ce que vous délierez sur la terre sera délié dans le ciel (2).
...
\begin{center}
\textit{[Parabole du serviteur impitoyable]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Enseignement de Jésus sur le mariage et le divorce]}
\end{center}
\Chap{19}
...
\begin{center}
\textit{[Parabole des ouvriers loués à des heures différentes]}
\end{center}
\Chap{20}
...
\begin{center}
\textit{[Demande des fils de Zébédée]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus guérit deux aveugles]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Entrée de Jésus-Christ dans Jérusalem]}
\end{center}
\Chap{21}
...
\begin{center}
\textit{[Jésus-Christ censure l'hypocrisie des scribes et des pharisiens]}
\end{center}
\Chap{23}
...
\begin{center}
\textit{[Prophétie sur la destruction du temple de Jérusalem et sur l'avènement de Jésus-Christ]}
\end{center}
\Chap{24}
...
\begin{center}
\textit{[Exhortation à la vigilance]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Parabole des dix vierges]}
\end{center}
\Chap{25}
...
\begin{center}
\textit{[Jugement des individus membres des nations (1 Co.6:2)]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus-Christ prédit sa mort]}
\end{center}
\Chap{26}
...
\begin{center}
\textit{[Une femme répand un parfum sur sa tête]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Jésus livré aux Juifs et en butte aux outrages]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Résurrection et apparition de Jésus-Christ]}
\end{center}
\Chap{28}
