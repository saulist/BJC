...
\begin{multicols}{2}
\begin{center}
\textit{[Généalogie de Jésus-Christ]}
\end{center}
\Chap{1}
\VerseOne{}Livres de la généalogie de Jésus-Christ, fils de David, fils d’Abraham.
...
\VS{5}Salmon engendra Boaz, de Rahab (1); Boaz engendra Obed, de Ruth (2) ; Obed engendra Isaï ;
...
\VS{16}Jacob engendra Joseph, l’époux de Marie, de laquelle est né Jésus, qui est appelé Christ (3).
...
\VS{20}Mais comme il y pensait, voici, l'Ange du Seigneur (4) lui apparut en songe et lui dit : Joseph, fils de David, ne crains point de prendre avec toi Marie, ta femme, car l’enfant qu’elle a conçu est du Saint-Esprit.
...
\VS{23}Voici, la vierge deviendra enceinte, elle enfantera un fils ; et on lui donnera le nom d’Emmanuel (5), ce qui signifie, Dieu est avec nous.
...
\begin{center}
\textit{[Il célèbre la pâque et institue la cène]}
\end{center}
\PPE{}
