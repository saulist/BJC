...
\VS{6}Et toi, Bethléem, terre de Juda, tu n'es nullement la plus petite parmi les gouverneurs de Juda, car de toi sortira le chef qui paîtra mon peuple d'Israël{\FTNT{Mi. 5:1.}}.
...
\TextTitle{[Le sel de la terre et la lumière du monde]
...
\TextTitle{[Le standard de l'Amour]
\\(Lu. 6:27-36)}
...
\VS{12}Et remet nous nos dettes{\FTNT{Du grec "opheilema" : "ce qui est légalement dû, une dette". Les ecritures considèrent le péché comme une dette. Voir Mat. 18:21-35}}. comme nous aussi nous remettons les dettes à nos débiteurs.
...
\VS{18}afin qu'il ne paraîsse pas aux hommes que tu jeûnes, mais à ton Père qui est présent dans ton lieu secret ; et ton Père qui te voit dans ton lieu secret, te récompensera publiquement.
...
\VS{26}Considérez les oiseaux du ciel ; car ils ne sèment, ni ne moissonnent, ni n'assemblent dans des greniers, et cependant votre Père céleste les nourrit. N'êtes vous pas beaucoup plus excellent qu'eux ?
...
\TextTitle{[Le jugement hypocrite]
\\(Luc. 6:37-42)}
\Chap{7}
...
\TextTitle{[La règle d'or de la loi et des prophètes]
\\(Lu. 6:31; Ep.4:32)}
...
\TextTitle{[Le serviteur d'un centenier guérit]
\\(Lu. 7:1-10)}
...
\TextTitle{[La belle-mère de Pierre guérit]
...
\TextTitle{[Les disciples eprouvés dans leur consécration]
\\(Lu. 9:57-62)}
...
\TextTitle{[Un paralytique guérit]
...
\TextTitle{[L'appel des pécheurs]
...
\TextTitle{[Deux aveugles et un démoniaque guérit]}
...
\TextTitle{[La condamnation de cette génération par la reine de Séba]
\\(2 ch. 9:1-12)}
...
\TextTitle{[La cécité des pharisiens]
\\(Mc. 8:10-14)}
\Chap{16}
...
\TextTitle{[Le manque de foi des disciples]
...
\TextTitle{[La pièce d'argent dans la bouche d'un poisson]
\\(Mc. 12:13-17)}
...
\VS{17}S’il refuse de les écouter, dis-le à l'Eglise ; et s'il refuse aussi d’écouter l'Eglise, qu'il soit pour toi comme un gentils et comme un publicain.
...
\VS{19}Ils le livreront aux gentils pour qu’ils se moquent de lui, le battent de verges, et le crucifient ; et le troisième jour il ressuscitera.
...
\TextTitle{[L'incrédulité des principaux sacrificateurs et des anciens]
...
\\(Mc. 12:38-40 ; Lu. 11:39-54 ; Lu. 20:45-47)}
\Chap{23}
...
\TextTitle{[Le signe de l'accomplissement]
\\(Mc. 13:3-4 ; Lu. 21:7)}
...
\\(Da. 9:27) ; les temps de la fin (Mc. 13:5-13 ; Lu. 21:8-11)}
...
\TextTitle{[Geste prophétique de Marie de Béthanie]
\\(Mc. 14:3-9 ; Jn. 12:1-8)}
...
\\(Mc. 14:12-21 ; Lu. 22:7-20 ; Jn. 13:1-12)}
...
\TextTitle{[Le Roi couronné d'épines ; Sa marche vers Golgotha]
