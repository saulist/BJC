...
\begin{center}
\textit{[Il commence son ministère en Galilée]}
\end{center}
\PPE{}
...
\VS{15}Le pays de Zabulon et le pays de Nephthali, de la contrée voisine de la mer, au-delà du Jourdain, et la Galilée des païens ;
...
\begin{center}
\textit{[Pierre et André, Jacques et Jean]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le Seigneur prêche sur une montagne]}
\end{center}
\Chap{5}
...
\begin{center}
\textit{[Continuation du discours de Jésus-Christ]}
\end{center}
\Chap{6}
...
\begin{center}
\textit{[Fin du discour de Jésus-Christ - Guérison d'un lépreux]}
\end{center}
\Chap{8}
...
\begin{center}
\textit{[Le serviteur d'un centenier]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Discours sur Jean-Baptiste]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Le péché contre le Saint-Esprit]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[du trésor caché, de la perle et du filet.]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Il paye les deux drachmes]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[De l'humilité et du scandale]}
\end{center}
\Chap{18}
...
\begin{center}
\textit{[Son autorité dans le temple]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Prédiction de la ruine du temple et de la nation juive. Prédiction de l'avènement de Jésus-Christ]}
\end{center}
\Chap{24}
...
\begin{center}
\textit{[Paraboles des dix vierges,]}
\end{center}
\Chap{25}
...
\begin{center}
\textit{[Description du jugement dernier]}
\end{center}
\PPE{}
