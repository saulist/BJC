...
\TextTitle{[L'Evangile de Christ, puissance de Dieu pour le salut]}
...
\TextTitle{[La révélation de la colère de Dieu]}
...
\TextTitle{[L'univers, une révélation de la puissance et de la suprématie de Dieu]}
...
\TextTitle{[Les progrès de l'incrédulité dans le monde]}
...
\TextTitle{[les conséquences de l'incrédulité pour le monde]}
...
\TextTitle{[Les moralistes ne sont pas meilleurs que les païens]}
\Chap{2}
...
\TextTitle{[Les juifs, conniassant la loi, sont condamnés par la loi]}
...
\TextTitle{[Les privilèges des Juifs augmentent leur condamnation]}
\Chap{3}
...
\TextTitle{[Le verdict général : le monde entier est coupable devant Dieu]}
...
\TextTitle{[La justification par la foi en Christ]}
...
\TextTitle{[La justification, solution au péché]}
...
\TextTitle{[La justification par la foi confirme la loi]}
\VS{31}Anéantissons-nous donc la loi par la foi ? Nullement ! Mais au contraire, nous affermissons la loi.
\TextTitle{[La justification par la foi prouvée par l'exemple d'Abraham et David]
\\(cp. v. 18-25)}
\Chap{4}
...
\TextTitle{[La justification s'accomplit sans les ordonnances]}
...
\TextTitle{[Conséquences de la justification]}
\Chap{5}
...
\TextTitle{[Parallèle et comparaison entre Jésus-Christ et Adam]}
...
\TextTitle{[La délivrance de la puissance du péché par l'identification avec Christ dans sa mort et sa résurrection]}
\Chap{6}
...
\TextTitle{[La délivrance de la puissance du péché par la mort à l'ancienne vie et la soumission à Dieu]}
...
\TextTitle{[La délivrance de la puissance du péché par l'abandon des oeuvres à travers la mort et la puissance de l'Esprit]}
...
\TextTitle{[La délivrance de la puissance du péché par la relation du chrétien uni à Christ]}
\Chap{7}
...
\TextTitle{[La délivrance de la puissance du péché par l'illumination de l'impuissance de la loi]}
...
\TextTitle{[La délivrance de la puissance du péché par la prise de conscience du combat entre la vieille nature et la nouvelle]}
...
\TextTitle{[La délivrance de la puissance du péché par l'Esprit qu ilibère de la vieille nature et produit la justice]}
\Chap{8}
...
\TextTitle{[La délivrance de la puissance du péché par la victoire de l'Esprit sur la vieille nature]
\\(cp. Ga. 5:15-18)}
...
\TextTitle{[La délivrance de la puissance du péché par le principe de l'adoption. Le chrétien devient fils et héritier]
\\(Ga. 4:7)}
...
\TextTitle{[La délivrance de la puissance du péché par la perspective de la gloire à venir]
\\(cp. Ge. 3:18-19)}
...
\TextTitle{[La délivrance de la puissance du péché par l'Esprit qui intercède]
\\(Hé. 7:25)}
...
\TextTitle{[La délivrance de la puissance du péché par l'objectif éternel et infaillible de Dieu par l'Evangile]}
...
\TextTitle{[La délivrance de la puissance du péché par la sécurité absolue du chrétien]}
...
\TextTitle{[Les sentiments de Paul pour Israël]}
\Chap{9}
...
\TextTitle{[Les privilèges d'israël]}
...
\TextTitle{[La postérité naturelle diffère de la postérité spirituelle]}
...
\TextTitle{[Illustration de cette différence]}
...
\TextTitle{[La miséricorde de Dieu dépend de sa volonté souveraine]}
\VS{14}Que dirons-nous donc : Y a-t-il de l’injustice en Dieu ? Loin de là !
\VS{15}Car il dit à Moïse : J'aurai compassion de qui j’ai compassion et je ferai miséricorde à qui je fais miséricorde\FTNT{Ex. 33:19.}.
...
\TextTitle{[Les prophètes ont prophétisé l'aveuglement d'Israël et la grâce offerte aux païens]}
...
\VS{26}et là où on leur disait : Vous n’êtes pas mon peuple ! Ils seront appelés fils du Dieu vivant\FTNT{Os. 2:1.}.
...
\VS{28}Car le Seigneur exécutera pleinement et promptement sur la terre ce qu’il a résolu\FTNT{Es. 10:22-23.}.
...
\TextTitle{[L'incrédulité d'Israël, cause de l'apparente irréalisation des promesses]}
\Chap{10}
...
\VS{4}Car Christ est la fin de la loi\FTNT{Il est question de la loi cérémonielle relative au culte mosaïque. Avant sa mort, Jésus qui était né sous la loi (Ga. 4:4), demandait aux gens de l’appliquer. Ainsi, il demanda au lépreux qu’il avait guéri de présenter une offrande pour sa purification au temple (Mt. 8:1-4). En effet, il fallait que les lois cérémonielles soient respectées jusqu’à sa résurrection. Une fois que Jésus a dit ~tout est accompli~ (Jn. 19:30), toutes ces lois n’avaient plus aucune raison d’être (Col. 2:14-17 ; Hé. 7:11-22 ; Hé. 10:1-2).} pour la justification de tous ceux qui croient.
...
\TextTitle{[La proclamation de l'Evangile aux nations]}
...
\TextTitle{[Le salut en Christ est trouvé par une partie des Israélites]}
\Chap{11}
...
\TextTitle{[La nation d'Israël est temporairement mise à l'écart, mais elle n'est pas définitivement rejetée]}
...
\TextTitle{[Le libérateur sauvera Israël après sa repentance]}
...
\VS{2}Et ne vous conformez pas au siècle présent, mais soyez transformés\FTNT{Le verbe ~transformer~ est la traduction du terme grec ~metamorphoo~ qui a donné en français ~transfigurer~. C’est le même terme qui a été utilisé en Mt. 17:2 pour parler de la transfiguration du Seigneur. Si Paul recommandait cela à des personnes déjà converties, c’est parce que Dieu les appelait à aller plus loin. La transformation d’une chenille en papillon est un très bel exemple pour illustrer le changement radical qui doit s’opérer en nous. Pour atteindre ce stade, cet insecte passe par plusieurs étapes. La transformation nous permet de croître spirituellement. En effet, tout enfant de Dieu est appelé à devenir mature, à passer du stade de petit enfant à celui de jeune gens, et de celui de jeune gens à celui de père (1 Jn. 2:12-14).} par le renouvellement de votre entendement, afin que vous discerniez quelle est la volonté de Dieu, ce qui est bon, agréable et parfait.
\TextTitle{[Exhortation à l'humilité et au service du chrétien par les dons de l'Esprit]}
...
\TextTitle{[La charité et les relations du chrétien]}
...
\TextTitle{[Les relations du chrétiens avec les hommes]}
...
\TextTitle{[Le devoir chrétien envers les autorités]}
\Chap{13}
...
\TextTitle{[La position du chrétien : Juifs et gentils sont unis dans un salut commun]}
...
\VS{9}afin que les païens glorifient Dieu pour sa miséricorde, selon ce qui est écrit : C’est pourquoi je te louerai parmi les nations, et je chanterai à la gloire de ton Nom\FTNT{Ps. 18:50.}. Et il est dit encore :
...
\TextTitle{[Paul par le de son prochain voyage à Jérusalem, à Rome et en Espagne]}
...
\VS{21}Ceux à qui il n'a point été annoncé le verront ; et ceux qui n'en avaient point entendu parler l’entendront\FTNT{Es. 52:15.}.
...
\TextTitle{[Paul adresse ses salutations personnelles]}
\Chap{16}
