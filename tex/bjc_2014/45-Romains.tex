...
\VS{17}parce qu’en lui est révélé la justice de Dieu pleinement de foi en foi, selon qu'il est écrit : Le juste vivra par la foi\FTNT{Ha. 2:4.}.
...
\VS{3}Car que dit l'Ecriture ? Qu’Abraham a cru en Dieu, et que cela lui a été imputé à justice\FTNT{} (1).
...
\VS{8}Heureux l'homme à qui le Seigneur n’impute pas son péché\FTNT{} (2).
...
\VS{17}selon qu'il est écrit : Je t'ai établi père de plusieurs nations\FTNT{} (3). Il est notre père devant celui auquel il a cru, Dieu qui donne la vie aux morts, et qui appelle les choses qui ne sont point, comme si elles étaient.
...
\Chap{5}
\VerseOne{}Etant donc justifiés\FTNT{} (1) par la foi, nous avons la paix avec Dieu, par notre Seigneur Jésus-Christ.
...
\VS{7}Que dirons-nous donc ? La loi est-elle péché ? Nullement ! Au contraire, je n'ai connu le péché que par la loi ; car je n’aurais pas connu la convoitise, si la loi n’avait pas dit : Tu ne convoiteras point\FTNT{} (1).
...
\VS{23}Et non seulement elles, mais nous aussi, qui avons les prémices de l'Esprit ; nous-mêmes, dis-je, soupirons en nous-mêmes, en attendant l'adoption, c'est-à-dire la rédemption de notre corps\FTNT{} (2).
...
\VS{9}Car voici la parole de la promesse : Je viendrai à cette même époque, et Sara aura un fils\FTNT{} (1).
...
\VS{12}il lui fut dit : L’aîné sera assujetti au plus petit\FTNT{} (2), selon qu’il est écrit :
\VS{13}J'ai aimé Jacob, et j'ai haï Esaü\FTNT{} (3).
...
\VS{26}et là où on leur disait : Vous n’êtes pas mon peuple ! Ils seront appelés fils du Dieu vivant\FTNT{} (6).
...
\VS{28}Car le Seigneur exécutera pleinement et promptement sur la terre ce qu’il a résolu\FTNT{} (7).
...
\VS{4}Car Christ est la fin de la loi\FTNT{} (1) pour la justification de tous ceux qui croient.
\VS{5}En effet, Moïse décrit ainsi la justice qui vient de la loi : L'homme qui fera ces choses vivra par elles\FTNT{} (2).
...
\VS{11}Quiconque croit en lui ne sera point confus\FTNT{} (3).
...
\VS{13}Car quiconque invoquera le nom du Seigneur sera sauvé\FTNT{} (4).
\TextTitle{[grandeur]}
...
\VS{16}Mais tous n'ont pas obéi à l'Evangile ; car Esaïe dit : Seigneur, qui a cru à notre prédication\FTNT{} (6) ?
...
\VS{21}Mais au sujet d’Israël, il dit : J'ai tout le jour tendu mes mains vers un peuple rebelle et contredisant\FTNT{} (9).
...
\VS{3}Seigneur, ils ont tué tes prophètes, et ils ont démoli tes autels, et je suis resté moi seul ; et ils cherchent à m'ôter la vie\FTNT{} (1).
\VS{4}Mais quelle réponse Dieu lui donna-t-il ? Je me suis réservé sept mille hommes, qui n'ont point fléchi le genou devant Baal\FTNT{} (2).
...
\VS{8}selon qu'il est écrit : Dieu leur a donné un esprit d’assoupissement, des yeux pour ne point voir, et des oreilles pour ne point entendre\FTNT{} (3), jusqu’à ce jour. Et David dit :
\VS{9}Que leur table soit pour eux un filet, un piège, une occasion de chute, et cela pour leur récompense.
\VS{10}Que leurs yeux soient obscurcis pour ne point voir\FTNT{} (4) ; et tiens continuellement leur dos courbé !
...
\VS{27}et c'est là l'alliance que je ferai avec eux, lorsque j'ôterai leurs péchés\FTNT{} (5).
...
\VS{2}Et ne vous conformez pas au siècle présent, mais soyez transformés\FTNT{} (1) par le renouvellement de votre entendement, afin que vous discerniez quelle est la volonté de Dieu, ce qui est bon, agréable et parfait.
...
\VS{19}Ne vous vengez point vous-mêmes, mes bien-aimés, mais laissez agir la colère de Dieu, car il est écrit : A moi appartient la vengeance, à moi la rétribution, dit le Seigneur\FTNT{} (2).
...
\VS{9}En effet, les commandements : Tu ne commettras point d’adultère, tu ne tueras point, tu ne déroberas point, tu ne convoiteras point, et ceux qu’il peut encore y avoir, se résument dans cette parole : Tu aimeras ton prochain comme toi-même\FTNT{} (1).
...
\VS{12}La nuit est avancée\FTNT{} (2) et le jour approche. Rejetons donc les œuvres des ténèbres, et soyons revêtus des armes de lumière.
\VS{13}Marchons honnêtement, comme en plein jour, loin des orgies\FTNT{} (3) et de l’ivrognerie, de la luxure et de la débauche, des querelles et des jalousies.
...
\VS{3}Car même Jésus-Christ n'a pas cherché ce qui lui plaisait, mais, selon qu’il est écrit : Les outrages de ceux qui t’insultent sont tombés sur moi\FTNT{} (1).
...
\VS{9}afin que les païens glorifient Dieu pour sa miséricorde, selon ce qui est écrit : C’est pourquoi je te louerai parmi les nations, et je chanterai à la gloire de ton Nom\FTNT{} (2). Et il est dit encore :
\VS{10}Nations, réjouissez-vous avec son peuple\FTNT{} (3) !
\VS{11}Et encore : Louez le Seigneur, vous toutes les nations, et célébrez-le, vous tous les peuples\FTNT{} (4). Esaïe dit aussi :
\VS{12}Il sortira d’Isaï un rejeton, qui se lèvera pour régner sur les nations ; les nations espéreront en lui\FTNT{} (5).
...
\VS{21}Ceux à qui il n'a point été annoncé le verront ; et ceux qui n'en avaient point entendu parler l’entendront\FTNT{} (6).
...
\VS{31}afin que je sois délivré des incrédules de Judée, et que mon ministère\FTNT{} (7) à Jérusalem soit agréable aux saints,
