...
\\(ce qui David avait annoncé, v. 25-31 ; cp. Ps. 16:8-11)}
...
\TextTitle{[Ils sont mis en prison et miraculeusement délivrés. Nouvel interrogatoire devant le Sanhédrin]}
...
\TextTitle{[discours de Gamaliel]}
...
\TextTitle{[Etablissement de sept diacres]}
\Chap{6}
...
\TextTitle{[Etienne, l'un des diacres, est accusé de blasphème]}
...
\TextTitle{[Discours d'Etienne devant le conseil des Juifs]}
\Chap{7}
...
\TextTitle{[Etienne meurt lapidé]}
...
\TextTitle{[Saul persécute les fidèles]}
\Chap{8}
...
\TextTitle{[Conversion des Samaritains]}
...
\TextTitle{[Conversion de l'eunuque éthiopien]}
...
\TextTitle{[Paul est baptisé par Ananias et prêche à Damas]}
...
\TextTitle{[Paul à Jérusalem, à Césarée et à Tarse]}
...
\TextTitle{[Pierre guérit un paralytique]}
...
\TextTitle{[Paul ressuscite Tabitha]}
...
\TextTitle{[Vision du centenier Corneille]}
\Chap{10}
...
\TextTitle{[Pierre, instruit par une vision, se rend chez Corneille]}
...
\TextTitle{[Pierre prêche l'Evangile chez Corneille]}
...
\TextTitle{[Le Saint-Esprit descend sur ses auditeurs]}
...
\TextTitle{[Barnabas, et Saul à Antioche]}
...
\TextTitle{[Martyre de Jacques, frère de Jean - Pierre est mis en prison - un ange le délivre]}
\Chap{12}
...
\TextTitle{[Mission de Paul et de Barnabas]}
\Chap{13}
...
\TextTitle{[Paul et Barnabas à Iconium]}
\Chap{14}
...
\TextTitle{[Paul et Barnabas guérissent à Lystre un impotent, sont pris pour des dieux par le peuple]}
...
\TextTitle{[Paul et Barnabas lapidés et leur retour à Antioche]}
...
\TextTitle{[Paul prend avec lui Timothée]}
\Chap{16}
...
\TextTitle{[Le Seigneur l'appelle en Macédoine]}
...
\TextTitle{[Séjour à Philippes. Conversion de Lydie]}
...
\TextTitle{[Paul et Silas en prison]}
...
\TextTitle{[Séjour de Paul à Bérée]}
...
\TextTitle{[Voyage à Jérusalem. Paul visite en passant plusieurs Eglises]}
...
\TextTitle{[Apollos à Ephèse et en Achaïe]}
...
\TextTitle{[Prédication de Paul à Ephèse]}
\Chap{19}
...
\TextTitle{[Emeute excitée par l'orfèvre Démétrius]}
...
\TextTitle{[Paul va en Macédoine et en Grèce]}
\Chap{20}
...
\TextTitle{[Prédication à Troas ; Eutychus]}
...
\TextTitle{[Paul prend congé des pasteurs d'Ephèse]}
