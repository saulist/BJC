...
\TextTitle{[Explication : la venue de l'Esprit Ascension de Jésus-Christ]}
...
\TextTitle{[Conversion de trois mille âmes]}
...
\TextTitle{[Union et piété des premiers chrétiens]}
...
\TextTitle{[Pierre guérit un impotent]}
\Chap{3}
...
\TextTitle{[Il exhorte les Juifs à se repentir et à se convertir]}
...
\TextTitle{[Pierre et Jean emprisonnés]}
\Chap{4}
...
\TextTitle{[Pierre et Jean sont relâchés avec menaces]}
...
\TextTitle{[Les fidèles implorent le secours de Dieu]}
...
\TextTitle{[Leur union et leur charité]}
...
\TextTitle{[Miracles des apôtres]}
