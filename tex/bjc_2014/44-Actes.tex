...
\begin{multicols}{2}
\textit{[Ascension de Jésus-Christ]}
\Chap{1}
...
\textit{[Matthias élu apôtre à la place de Judas]}
...
\textit{[La Pentecôte, descente du Saint-Esprit]}
\Chap{2}
...
\textit{[Conversion de trois mille âmes]}
...
\textit{[Union et piété des premiers chrétiens]}
...
\textit{[Pierre guérit un impotent]}
\Chap{3}
...
\textit{[Il exhorte les Juifs à se repentir et à se convertir]}
...
\textit{[Pierre et Jean emprisonnés]}
\Chap{4}
...
\textit{[Pierre et Jean comparaissent devant le Sanhédrin]}
...
\textit{[Pierre et Jean sont relâchés avec menaces]}
...
\textit{[Les fidèles implorent le secours de Dieu]}
...
\textit{[Leur union et leur charité]}
...
\textit{[Ils sont mis en prison et miraculeusement délivrés. Nouvel interrogatoire devant le Sanhédrin]}
...
\textit{[Etablissement de sept diacres]}
\Chap{6}
...
\textit{[Etienne, l'un des diacres, est accusé de blasphème]}
...
\textit{[Discours d'Etienne devant le conseil des Juifs]}
\Chap{7}
...
\textit{[Saul persécute les fidèles]}
\Chap{8}
...
\textit{[Conversion des Samaritains]}
...
\textit{[Conversion de l'eunuque éthiopien]}
...
\textit{[Paul est baptisé par Ananias et prêche à Damas]}
...
\textit{[Paul à Jérusalem, à Césarée et à Tarse]}
...
\textit{[Pierre guérit un paralytique]}
...
\textit{[Vision du centenier Corneille]}
\Chap{10}
...
\textit{[Pierre, instruit par une vision, se rend chez Corneille]}
...
\textit{[Pierre prêche l'Evangile chez Corneille]}
...
\textit{[Le Saint-Esprit descend sur ses auditeurs]}
...
\textit{[Pierre, de retour à Jérusalem, justifie sa conduite]}
\Chap{11}
...
\textit{[Barnabas, et Saul à Antioche]}
...
\textit{[Martyre de Jacques, frère de Jean - Pierre est mis en prison - un ange le délivre]}
\Chap{12}
...
\textit{[Mission de Paul et de Barnabas]}
\Chap{13}
...
\textit{[Paul et Barnabas prêchent dans l'île de Cypre et à Paphos. Elymas aveuglé. Le proconsul Serge Paul converti]}
...
\textit{[Prédication de Paul à Antioche de Pisidie]}
...
\textit{[Paul et Barnabas à Iconium]}
\Chap{14}
...
\textit{[Paul et Barnabas guérissent à Lystre un impotent, sont pris pour des dieux par le peuple]}
...
\textit{[Paul et Barnabas lapidés et leur retour à Antioche]}
...
\textit{[Décision du Synode de l'Eglise à Jérusalem sur l'observation des cérémonies de la loi relativement aux Gentils]}
\Chap{15}
...
\textit{[Paul et Barnabas se séparent]}
...
\textit{[Paul prend avec lui Timothée]}
\Chap{16}
...
\textit{[Le Seigneur l'appelle en Macédoine]}
...
\textit{[Séjour à Philippes. Conversion de Lydie]}
...
\textit{[Séjour de Paul à Thessalonique]}
\Chap{17}
...
\textit{[Séjour de Paul à Athènes]}
...
\textit{[Prédication de Paul à l'aréopage]}
...
\textit{[Paul demeure à Corinthe un an et demi]}
\Chap{18}
...
\textit{[Voyage à Jérusalem. Paul visite en passant plusieurs Eglises]}
...
\textit{[Apollos à Ephèse et en Achaïe]}
...
\textit{[Prédication de Paul à Ephèse]}
\Chap{19}
...
\textit{[Emeute excitée par l'orfèvre Démétrius]}
...
\textit{[Paul va en Macédoine et en Grèce]}
\Chap{20}
...
\textit{[Prédication à Troas ; Eutychus]}
...
\textit{[Paul prend congé des pasteurs d'Ephèse]}
...
\textit{[Paul à Ptolémaïs, puis à Césarée -  le prophète Agabus]}
...
\textit{[Paul se purifie et entre dans le temple]}
...
\textit{[Paul est saisi et maltraité par les Juifs]}
...
\textit{[Discours de Paul aux Juifs sur sa conversion]}
\Chap{22}
...
\textit{[Les juifs demandent la mort de Paul]}
...
\textit{[Paul, menacé de la question, se déclare citoyen romain]}
...
\textit{[Paul devant le Conseil des Juifs]}
\Chap{23}
...
\textit{[Dissension entre ses accusateurs]}
...
\textit{[Le Seigneur fortifie Paul]}
...
\textit{[Quelques Juifs font vœu de le tuer ; le tribun, prévenu de ce complot, envoie Paul à Césarée]}
...
\textit{[Défense de Paul devant Félix, à Césarée]}
...
\textit{[Paul prêche Christ au gouverneur et à sa femme]}
...
\textit{[Paul se justifie devant Festus et en appelle à César]}
\Chap{25}
...
\textit{[Le roi Agrippa se trouvant à Césarée]}
...
\textit{[Paul est amené devant lui]}
...
\textit{[Discours de Paul devant Agrippa]}
\Chap{26}
...
\textit{[Festus interrompt Paul ; réponse de Paul, qui prend à témoin Agrippa presque persuadé]}
...
\textit{[Innocence de Paul reconnue]}
...
\textit{[Paul relève les courages abattus]}
...
\textit{[Paul dans l'île de Malte]}
\Chap{28}
...
\textit{[Paul guérit le père de Publius]}
...
\textit{[Paul, arrivé à Rome, s'y fait connaître aux Juifs et y prêche pendant deux ans]}
