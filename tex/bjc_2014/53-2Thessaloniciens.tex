...
\begin{multicols}{2}
\begin{center}
\textit{[Exhortation à la piété et à la constance dans les afflictions]}
\end{center}
\Chap{1}
...
\begin{center}
\textit{[Caractères de l'Antichrist]}
\end{center}
\Chap{2}
...
\VS{4}l’adversaire qui s'élève contre tout ce qui est nommé Dieu, ou qu'on adore, il va jusqu'à s’asseoir comme Dieu dans le temple de Dieu (3), se proclamant lui-même Dieu.
...
\begin{center}
\textit{[Actions de grâces et vœux pour les Thessaloniciens]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Exhortation à prier pour l'avancement de l'Evangile]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[Exhortation à se séparer de ceux qui mènent une vie déréglée]}
\end{center}
\PPE{}
