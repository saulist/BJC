...
\begin{multicols}{2}
\textit{[Jésus-Christ, Fils de Dieu, élevé au-dessus des anges et de toutes les créatures]}
\Chap{1}
...
\textit{[Exhortation à ne pas négliger le salut en Christ, auquel toutes choses ont été assujetties]}
\Chap{2}
...
\textit{[Il a fallu que le Fils de Dieu revêtît notre humanité]}
...
\textit{[Supériorité de Jésus-Christ sur Moïse]}
\Chap{3}
...
\textit{[Danger de l'endurcissement et de l'incrédulité]}
...
\textit{[De la participation au repos de Dieu]}
\Chap{4}
...
\textit{[Exhortation à la fermeté et à la confiance]}
...
\textit{[Jésus-Christ a reçu la dignité de souverain Sacrificateur]}
\Chap{5}
...
\textit{[Du danger d'abandonner la foi]}
\Chap{6}
...
\textit{[Abraham, exemple de confiance dans les promesses irrévocables de Dieu]}
...
\textit{[L'espérance, ancre de notre âme]}
...
\textit{[De la sacrificature de Melchisédec]}
\Chap{7}
...
\textit{[Supériorité du sacerdoce de Christ sur celui d'Aaron]}
...
\textit{[Excellence du sacerdoce de Christ. Promesse de Dieu touchant la nouvelle alliance]}
\Chap{8}
...
\textit{[Comparaison du tabernacle et du sacerdoce lévitique avec le sacerdoce de Jésus-Christ]}
\Chap{9}
...
\textit{[La loi n'avait que l'ombre des biens à venir et Christ, par son seul sacrifice, nous a entièrement rachetés]}
\Chap{10}
...
\textit{[Exhortation à la confiance, à la fermeté dans la foi, à la fidélité et à la patience]}
...
\textit{[Efficacité de la foi : exemples divers tirés du tanakh]}
\Chap{11}
...
\textit{[Tout souffrir pour Christ et à son exemple]}
\Chap{12}
...
\textit{[Le Seigneur châtie celui qu'il aime]}
...
\textit{[La supériorité de la nouvelle alliance, motif de fermeté et de vigilance]}
...
\textit{[Persévérance dans la vraie foi]}
