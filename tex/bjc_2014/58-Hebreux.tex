...
\begin{multicols}{2}
\TextTitle{[Jésus-Christ, Fils de Dieu, élevé au-dessus des anges et de toutes les créatures]}
\Chap{1}
...
\TextTitle{[Exhortation à ne pas négliger le salut en Christ, auquel toutes choses ont été assujetties]}
\Chap{2}
...
\TextTitle{[Il a fallu que le Fils de Dieu revêtît notre humanité]}
...
\TextTitle{[Supériorité de Jésus-Christ sur Moïse]}
\Chap{3}
...
\TextTitle{[Danger de l'endurcissement et de l'incrédulité]}
...
\TextTitle{[De la participation au repos de Dieu]}
\Chap{4}
...
\TextTitle{[Efficacité de la Parole]}
...
\TextTitle{[Jésus-Christ a reçu la dignité de souverain Sacrificateur]}
\Chap{5}
...
\TextTitle{[Du danger d'abandonner la foi]}
\Chap{6}
...
\TextTitle{[Abraham, exemple de confiance dans les promesses irrévocables de Dieu]}
...
\TextTitle{[L'espérance, ancre de notre âme]}
...
\TextTitle{[De la sacrificature de Melchisédec]}
\Chap{7}
...
\TextTitle{[Supériorité du sacerdoce de Christ sur celui d'Aaron]}
...
\TextTitle{[Excellence du sacerdoce de Christ. Promesse de Dieu touchant la nouvelle alliance]}
\Chap{8}
...
\TextTitle{[Comparaison du tabernacle et du sacerdoce lévitique avec le sacerdoce de Jésus-Christ]}
\Chap{9}
...
\TextTitle{[La loi n'avait que l'ombre des biens à venir et Christ, par son seul sacrifice, nous a entièrement rachetés]}
\Chap{10}
...
\TextTitle{[Exhortation à la confiance, à la fermeté dans la foi, à la fidélité et à la patience]}
...
\TextTitle{[Efficacité de la foi : exemples divers tirés du tanakh]}
\Chap{11}
...
\TextTitle{[Tout souffrir pour Christ et à son exemple]}
\Chap{12}
...
\TextTitle{[Le Seigneur châtie celui qu'il aime]}
...
\TextTitle{[La supériorité de la nouvelle alliance, motif de fermeté et de vigilance]}
...
\TextTitle{[Persévérance dans la vraie foi]}
