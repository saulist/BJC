...
\VS{2}nous a parlé dans ces derniers jours (1) par son Fils, qu'il a établi héritier de toutes choses, et par lequel il a aussi créé les siècles,
...
\VS{5}Car auquel des anges Dieu a-t-il jamais dit : Tu es mon Fils, je t'ai engendré aujourd'hui (2) ? Et encore : Je serai pour lui un Père, et il sera pour moi un Fils (3) ?
\VS{6}Et quand il introduit de nouveau dans le monde son Fils premier-né (4), il dit : Que tous les anges de Dieu l'adorent (5).
\VS{7}A l’égard des anges, Dieu dit : Il fait de ses anges des vents, et ses ministres des flammes de feu (6).
...
\VS{9}Tu as aimé la justice, et tu as haï l'iniquité ; c'est pourquoi, ô Dieu ! Ton Dieu t'a oint d'une huile de joie au-dessus de tous tes semblables (7).
...
\VS{12}Et tu les rouleras comme un habit, et ils seront changés ; mais toi, tu restes le même, et tes années ne finiront point (8).
\VS{13}Et auquel des anges a-t-il jamais dit : Assieds-toi à ma droite, jusqu'à ce que je fasse de tes ennemis ton marchepied (9) ?
...
\TextTitle{[Avertissement à ceux qui entendent]}
\Chap{2}
...
\TextTitle{[Le but de Dieu : soumettre le monde à Christ qui fut Homme]}
...
\VS{8}Tu as mis toutes choses sous ses pieds (1). En effet, en lui soumettant toutes choses, Dieu n'a rien laissé qui ne lui soit pas soumis. Cependant, nous ne voyons pas encore que toutes choses lui soient soumises.
\TextTitle{[Jésus abaissé pour un peu de temps au-dessous des anges]}
...
\VS{12}lorsqu’il dit : J'annoncerai ton Nom à mes frères, et je te louerai au milieu de l'assemblée (2).
\VS{13}Et encore : Je me confierai en lui. Et encore : Me voici, moi et les enfants que Dieu m'a donnés (3).
...
\VS{6}Mais Christ l’est comme Fils sur sa maison ; et nous sommes sa maison (1), pourvu que nous retenions fermement jusqu’à la fin l'assurance et l'espérance dont nous nous glorifions.
\TextTitle{[Exhortation : la génération qu isortit d'Egypte n'entrera pas dans le repos de Canaan pour cause d'incrédulité]}
...
\VS{9}où vos pères me tentèrent pour m’éprouver, et ils virent mes œuvres pendant quarante ans (2).
...
\TextTitle{[Un meilleur repos pour le croyant]}
\Chap{4}
...
\VS{2}Car elle nous a été annoncée, aussi bien qu’à eux ; mais cette parole de la prédication ne leur servit de rien, parce qu'elle ne trouva pas de la foi chez ceux qui l’entendirent.
\VS{3}Pour nous qui avons cru, nous entrerons dans le repos, suivant ce qui a été dit : C'est pourquoi je jurai dans ma colère, ils n’entreront pas dans mon repos (1) ! Il dit cela quoique ses œuvres aient été achevées depuis la création du monde.
\VS{4}Car il a parlé quelque part ainsi du septième jour : Et Dieu se reposa de toutes ses œuvres le septième jour (2).
\VS{5}Et encore dans ce passage : Ils n’entreront pas dans mon repos.
\VS{6}Or puisqu’il est encore réservé à quelques-uns d’y entrer, et que ceux à qui d’abord la promesse a été faite n’y sont pas entrés à cause de leur incrédulité,
\VS{7}Dieu détermine de nouveau un certain jour, par ce mot : Aujourd'hui, en disant par David si longtemps après, selon ce qui a été dit : Aujourd'hui, si vous entendez sa voix, n'endurcissez point vos cœurs (3).
\VS{8}Car si Josué les avait introduits dans le repos, Dieu ne parlerait pas d'un autre jour.
\TextTitle{[Le croyant se repose en une oeuvre rédemptrice parfaite]}
...
\TextTitle{[Exhortation à la fermeté et à la confiance]}
...
\TextTitle{[L'office du souverain sacrificateur]}
\Chap{5}
...
\TextTitle{[Christ, souverain sacrificateur selon l'ordre de Melchisédek]}
\VS{5}De même aussi Christ ne s'est point attribué la gloire d’être Souverain Sacrificateur, mais il l’a reçue de celui qui lui a dit : C’est toi qui es mon Fils, je t'ai engendré aujourd'hui (1) !
\VS{6}Comme il est dit encore ailleurs : Tu es Sacrificateur éternellement selon l'ordre de Melchisédek (2).
...
\TextTitle{[Reproches et avertissements]
\\(jusqu'à Hé. 6:12)}
...
\VS{13}Or celui qui ne se nourrit que de lait, ne saurait comprendre la parole de justice, car il est encore un enfant (3).
...
\TextTitle{["Tendons à ce qui est parfait"]}
\Chap{6}
...
\VS{14}en disant : Certainement, je te bénirai et je multiplierai ta postérité (1).
...
\VS{20}là où Jésus est entré comme notre précurseur, ayant été fait Souverain Sacrificateur éternellement, selon l'ordre de Melchisédek (2).
\TextTitle{[Melchisédek est une figure de Christ]
\\(Ge. 14)}
\Chap{7}
...
\VS{2}et Abraham lui donna pour sa part la dîme de tout (2). Il est d’abord Roi de justice, d’après la signification de nom, ensuite Roi de Salem, c’est-à-dire Roi de paix.
...
\TextTitle{[Le sacerdoce de Melchisédek supèrieur à celui d'Aaron Introduction :
\\a. parce qu'Aaron a donné par Abraham la dîme à Melchisedek]}
...
\TextTitle{[b. parce que le sacerdoce selon l'ordre d'Aaron n'a rien amené à la perfection]}
...
\VS{14}Car il est évident que notre Seigneur est sorti de la tribu de Juda (3), tribu dont Moïse n'a rien dit au sujet de la sacrificature.
...
\VS{17}Car Dieu lui rend ce témoignage (4) : Tu es Sacrificateur éternellement, selon l'ordre de Melchisédek.
...
\VS{21}car les Lévites sont devenus sacrificateurs sans serment, mais Jésus l’est devenu avec serment par celui qui lui a dit : Le Seigneur l'a juré, et il ne s'en repentira pas (4) : Tu es Sacrificateur éternellement selon l'ordre de Melchisédek.
\VS{22}Jésus est par cela même le garant d’une alliance plus excellente.
\TextTitle{[c. parce que les sacrificateurs selon l'ordre d'Aaron sont mortels, mais Christ demeure éternellement]}
...
\VS{25}C'est aussi pour cela qu’il peut parfaitement sauver pour toujours ceux qui s'approchent de Dieu par lui, étant toujours vivant pour intercéder (5) en leur faveur.
...
\TextTitle{[d. parce que les sacrificateurs selon l'ordre d'Aaron célèbrent un culte qui est "l'ombre des choses célestes", mais la réalité est en Christ]}
\Chap{8}
...
\VS{5}lesquels célèbrent un culte, image et ombre des choses célestes, comme Moïse en fut divinement averti lorsqu’il allait construire le tabernacle : Prends garde, lui dit-il, de faire toutes choses selon le modèle qui t'a été montré sur la montagne (1).
\TextTitle{[e. parce que Christ est "le Médiateur d'une alliance plus excellence"]}
...
\\a. les prophètes l'ont annoncée}
...
\VS{12}car je pardonnerai leurs injustices, et je ne me souviendrai plus de leurs péchés ni de leurs iniquités (2).
...
\TextTitle{[b. les ordonnances et le sanctuaire de la première alliance n'étaient que des symboles]}
\Chap{9}
\VerseOne{}La première alliance avait donc des ordonnances relatives au culte divin et au sanctuaire terrestre (1).
\VS{2}En effet, un tabernacle fut construit. Dans la partie antérieure, appelée le lieu saint, étaient le chandelier, la table, et les pains de proposition (2).
\VS{3}Et au-delà du second voile (3) était la partie du tabernacle appelée le Saint des saints,
\VS{4}renfermant l’encensoir d'or (4) pour les parfums et l'arche de l'alliance (5) entièrement recouverte d'or. Il y avait dans l’arche un vase d'or (6) contenant la manne, la verge d'Aaron (7) qui avait fleuri, et les tables de l'alliance (8).
\VS{5}Et au-dessus de l'arche étaient les chérubins de la gloire, couvrant de leur ombre sur le propitiatoire (9). Ce n’est pas le moment de parler en détail là-dessus.
\VS{6}Or ces choses étant ainsi disposées, les sacrificateurs qui font le service entrent en tout temps dans la première partie du tabernacle (10).
\VS{7}Mais seul le souverain sacrificateur entre dans la seconde une fois par an, non sans y porter du sang, qu’il offre pour lui-même et pour les péchés du peuple (11).
...
\TextTitle{[c. le sanctuaire et le sacrifice de la nouvelle alliance sont des réalités]}
...
\VS{13}Car si le sang des taureaux et des boucs, et la cendre de la génisse (12), répandue sur ceux qui sont souillés, sanctifient, et procurent la pureté de la chair,
...
\TextTitle{[d. la nouvelle alliance expose les clauses du testament de Christ]}
...
\VS{20}Ceci est le sang de l’alliance que Dieu vous a ordonné d'observer (13).
\VS{21}Puis il fit de même l’aspersion avec le sang sur le tabernacle et sur tous les ustensiles du culte (14).
...
\TextTitle{[e. le sanctuaire céleste a été purifié par un sacrifice plus excellent]
\\(lé. 16:33)}
...
\VS{27}Et comme il est réservé aux hommes de mourir une seule fois (15), après quoi vient le jugement,
...
\TextTitle{[f. le sacrifice unique de la nouvelle alliance est supérieur aux nombreux sacrifices de la première]}
\Chap{10}
...
\VS{6}Tu n'as pas pris plaisir aux holocaustes ni aux sacrifices pour le péché (1).
...
\VS{16}Voici l'alliance que je ferai avec eux après ces jours-là, dit le Seigneur (2) : Je mettrai mes lois dans leurs cœurs, je les écrirai dans leur esprit ; il ajoute :
...
\TextTitle{[S'approcher de Dieu avec confiance]}
\VS{19}Ainsi donc, mes frères, nous avons la liberté d'entrer dans le Saint des saints au moyen du sang de Jésus,
\VS{20}qui est le chemin (2) nouveau et vivant qu'il nous a frayé au travers du voile, c’est-à-dire de sa chair.
...
\VS{25}N’abandonnons pas notre assemblée (3), comme c’est la coutume de quelques-uns, mais exhortons-nous réciproquement, et cela d'autant plus que vous voyez s’approcher le jour.
\TextTitle{[Avertissement aux indécis. Les sacrifices lévitiques ont perdu leur efficacité. Messie ou le jugement]}
...
\VS{28}Si quelqu'un avait méprisé la loi de Moïse, il mourait sans miséricorde, sur la déposition de deux ou de trois témoins (4).
...
\VS{30}Car nous connaissons celui qui a dit : A moi la vengeance, à moi la rétribution ! (5) Et encore : Le Seigneur jugera son peuple.
...
\VS{38}Et le juste vivra par la foi ; mais s’il se retire, mon âme ne prend pas plaisir en lui (6).
...
\TextTitle{[Définition de la foi. Supériorité de la vie par la foi]}
\Chap{11}
...
\TextTitle{[Exemples d'hommes de foi
\\a. Abel]}
\VS{4}C’est par la foi qu’Abel (1) offrit à Dieu un sacrifice plus excellent que celui de Caïn ; c’est par elle qu’il a reçu le témoignage d’être juste, Dieu rendant témoignage à ses offrandes ; et c’est par elle qu’il parle encore quoique mort.
\TextTitle{[b. Hénoc]}
\VS{5}C’est par la foi qu’Enoch (2) fut enlevé pour qu’il ne voie pas la mort, et il ne parut plus parce que Dieu l’avait enlevé ; car avant son enlèvement, il avait reçu le témoignage qu’il était agréable à Dieu.
...
\TextTitle{[c. Noé]}
\VS{7}C’est par la foi que Noé (3), divinement averti des choses qu’on ne voyait pas encore, fut rempli de crainte, et construisit une arche pour le salut de sa famille ; par cette arche, il condamna le monde et devint héritier de la justice qui s’obtient par la foi.
\TextTitle{[d. Abraham et Sara]}
\VS{8}C’est par la foi qu’Abraham (4), lors de sa vocation, obéit et partit pour une terre qu'il devait recevoir en héritage, et il partit sans savoir où il allait.
...
\VS{11}C’est par la foi que Sara (5) elle-même, malgré son âge avancé, fut rendue capable d’avoir une postérité, parce qu’elle crut à la fidélité de celui qui avait fait la promesse.
\VS{12}C'est pourquoi d'un seul, déjà usé de corps, naquit une postérité nombreuse comme les étoiles du ciel, comme le sable qui est sur le bord de mer et qu’on ne peut pas compter (6).
\VS{13}Tous ceux-là sont morts dans la foi, sans avoir obtenu les choses promises, mais ils les ont vues de loin, crues, et saluées, reconnaissant qu'ils étaient étrangers et voyageurs sur la terre (7).
...
\VS{16}Mais ils en désirent une meilleure, c'est-à-dire une céleste. C’est pourquoi Dieu n’a pas honte d'être appelé leur Dieu, parce qu'il leur a préparé une cité (8).
\VS{17}C’est par la foi qu’Abraham offrit Isaac lorsqu’il fut mis à l’épreuve, et qu’il offrit son fils unique (9), lui qui avait reçu les promesses,
\VS{18}et à qui il avait été dit : C’est en Isaac que ta postérité sera appelée de ton nom (10).
...
\TextTitle{[e. Isaac]}
\VS{20}C’est par la foi qu’Isaac bénit Jacob et Esaü, en vue des choses à venir (11).
\TextTitle{[f. Jacob]}
\VS{21}C’est par la foi que Jacob mourant bénit chacun des fils de Joseph (12), et adora Dieu, appuyé sur l’extrémité de son bâton (13).
\TextTitle{[g. Joseph]}
\VS{22}C’est par la foi que Joseph mourant fit mention de la sortie des enfants d'Israël, et qu’il donna des ordres au sujet de ses os (14).
\TextTitle{[h. les parents de Moïse]}
\VS{23}C’est par la foi que Moïse (15), à sa naissance, fut caché pendant trois mois par ses parents, parce qu’ils virent que l’enfant était beau, et ils ne craignirent pas l’ordre du roi.
\TextTitle{[i. Moïse]}
...
\VS{28}C’est par la foi qu’il célébra la Pâque et fit l'aspersion du sang, afin que l’exterminateur qui tuait les premiers-nés, ne touche pas aux premiers-nés des Israélites (16).
\VS{29}C’est par la foi qu’ils traversèrent la mer rouge, comme un lieu sec, tandis que les Egyptiens qui tentèrent de passer furent engloutis (17).
\TextTitle{[j. Josué et Jéricho]}
\VS{30}C’est par la foi que les murs de Jéricho tombèrent, après qu'on en eut fait le tour pendant sept jours (18).
\TextTitle{[k. Rahab]}
\VS{31}C’est par la foi que Rahab, la prostituée, ne périt pas avec les incrédules, parce qu’elle avait reçu les espions et les avait renvoyés en paix (19).
\TextTitle{[l. Nombreux hommes et femmes de la foi]}
\VS{32}Et que dirai-je encore ? Car le temps me manquerait si je voulais parler de Gédéon (20), de Barak (21), de Samson (22), de Jephté (23), de David (24), de Samuel (25), et des prophètes,
...
\TextTitle{[Adoration et marche du serviteur de Dieu
\\1. Jésus : l'exemple parfait]}
\Chap{12}
...
\TextTitle{[a. le châtiment du Père]}
...
\VS{6}car le Seigneur châtie celui qu'il aime, et il frappe de la verge tous ceux qu’il reconnaît pour ses fils (2).
...
\TextTitle{[b. Esaü : un avertissement pour les chrétiens de nom]}
\VS{16}à ce qu’il n’y ait ni débauché, ni profane comme Esaü, qui pour un mets vendit son droit d’aînesse (3).
...
\TextTitle{[2. L'Eglise veritable ne s'est pas approchée du mont Sinaï (la loi), mais de la montagne de Sion (la Jerusalem célèste)]}
\VS{18}Vous ne vous êtes pas approchés d’une montagne qu’on pouvait toucher avec la main (4), ni du feu brûlant, ni de la nuée épaisse, ni de l'obscurité, ni de la tempête,
\VS{19}ni du retentissement de la trompette, ni du bruit des paroles, tel que ceux qui l'entendirent prièrent que la parole ne leur soit plus adressée (5) ;
\VS{20}car ils ne pouvaient pas supporter ce qui était ordonné : Même si une bête touche la montagne, elle sera lapidée ou percée d'un dard (6).
...
\TextTitle{[3. Avertissements et instructions "Dieu est un feu dévorant"]}
...
\VS{26}lui, dont la voix ébranla alors la terre, et qui maintenant a fait cette promesse, disant : Une fois encore j'ébranlerai non seulement la terre, mais aussi le ciel (7).
...
\VS{29}car notre Dieu est aussi un feu dévorant (8).
\TextTitle{[L'immuabilité de Christ]}
\Chap{13}
...
\VS{5}Ne vous livrez pas à l’amour de l’argent, contentez-vous de ce que vous avez, car Dieu lui-même a dit : Je ne te délaisserai point, et je ne t'abandonnerai point (1),
\VS{6}de sorte que nous pouvons dire avec assurance : Le Seigneur est mon aide, je ne craindrai point ce que l'homme pourrait me faire (2).
...
\TextTitle{[5. La séparation d'avec le monde]}
...
\VS{12}C'est pour cela que Jésus aussi, afin de sanctifier le peuple par son propre sang, a souffert hors de la porte (3).
\VS{13}Sortons donc pour aller à lui hors du camp (4), en portant son opprobre.
\VS{14}Car nous n'avons point ici-bas de cité permanente, mais nous recherchons celle qui est à venir.
\TextTitle{[6. L'adoration du chrétien et le sacrifice du serviteur de Dieu]}
...
\TextTitle{[7. L'obéissance aux serviteurs de Dieu]}
\VS{17}Obéissez (5) à vos conducteurs, et soyez-leur soumis, car ils veillent pour vos âmes, dont ils devront rendre compte ; qu’il en soit ainsi afin qu’ils le fassent avec joie, et non en gémissant ce qui ne vous serait d’aucun avantage.
