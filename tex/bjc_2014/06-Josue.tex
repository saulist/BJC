...
\par\nobreak\noindent\hrulefill
\begin{multicols}{2}
\TextTitle{[Josué succède à Moïse après sa mort]
\\(De. 34:9)}
\Chap{1}
...
\Chap{2}
\VerseOne{}Or, Josué fils de Nun, envoya secrètement de Sittim deux hommes, pour espionner le pays, et il leur dit : Allez, examinez le pays, et Jéricho. Ils partirent donc, et arrivèrent dans la maison d’une femme prostituée, nommée Rahab\FTNT{Rahab, la prostituée, est citée comme exemple de foi remarquable dans Hé. 11:31. La foi de Rahab a non seulement donné lieu à une déclaration solennelle sur le Dieu d’Israël : « ... car c’est Yahweh, votre Dieu, qui est Dieu en haut dans les cieux et en bas sur la terre ». Elle a également donné lieu à une action remarquable en faveur du peuple de Dieu (Ja. 2:25-26). Dans Jos. 6:25, il est écrit que Rahab vivait parmi les Israélites. Elle ne faisait qu’un avec le peuple de Dieu. Le fait qu’elle ait été une prostituée n’avait plus d’importance. Son passé fut oublié et par la foi, elle faisait partie de l’assemblée de Dieu. Rahab est devenue l’ancêtre de Jésus-Christ (Mt. 1:5).}, et ils y couchèrent.
