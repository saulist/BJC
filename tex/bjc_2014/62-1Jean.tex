...
\TextTitle{[d) la communion maintenue grâce à l'intercession de Christ, notre avocat]}
\Chap{2}
...
\TextTitle{[Exhortation à la pureté]}
...
\TextTitle{[b) leur attitude envers le monde]}
...
\TextTitle{[L'amour de Dieu dans le coeur du chrétien se prouve par une vie d'amour envers Lui et les hommes]}
