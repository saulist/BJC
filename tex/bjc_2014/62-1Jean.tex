...
\begin{multicols}{2}
\TextTitle{[Le témoignage de Jean concernant la Parole de vie]}
\Chap{1}
...
\TextTitle{[L'amour de nos frères]}
...
\TextTitle{[Plusieurs antichrists]}
...
\TextTitle{[La sainteté et la charité, marques et devoirs des enfants de Dieu]}
...
\TextTitle{[Leur assurance devant Dieu]}
...
\TextTitle{[L'amour de Dieu pour nous, nous engage à l'aimer et à aimer nos frères]}
...
\TextTitle{[Celui qui aime Dieu garde ses commandements - La foi rend victorieux du monde]}
\Chap{5}
...
\TextTitle{[Elle est fondée sur le témoignage de Dieu]}
