...
\begin{center}
\textit{[Du devoir de joindre à la foi les vertus chrétiennes et d'affermir sa vocation]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Sollicitude de l'Apôtre pour ses lecteurs ; autorité de son témoignage et de la parole des prophètes]}
\end{center}
\PPE{}
...
\begin{center}
\textit{[Prédiction de la venue de faux docteurs. Leur caractère et leur punition]}
\end{center}
\Chap{2}
...
\begin{center}
\textit{[Des moqueurs qui viendront aux derniers jours]}
\end{center}
\Chap{3}
...
\begin{center}
\textit{[De l'avènement du Seigneur et du renouvellement de toutes choses. Exhortation à la vigilance]}
\end{center}
\PPE{}
