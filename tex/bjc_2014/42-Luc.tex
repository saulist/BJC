...
\begin{multicols}{2}
\TextTitle{[Un ange annonce à Zacharie la naissance de Jean-Baptiste]}
\Chap{1}
...
\TextTitle{[Un ange annonce à Marie la naissance de Jésus-Christ]}
...
\TextTitle{[Marie visite Elisabeth. Cantique de Marie]}
...
\TextTitle{[Naissance de Jean-Baptiste et cantique de Zacharie]}
...
\TextTitle{[Naissance de Jésus-Christ]}
\Chap{2}
...
\textit{[Mission des douze apôtres]}
\Chap{9}
...
\textit{[Pierre reconnaît Jésus comme le Messie]}
...
\textit{[Prix de la consécration du disciple ]}
...
\textit{[Dispositions nécessaires pour suivre Jésus]}
...
\textit{[Mission des soixante-dix disciples]}
\Chap{10}
...
\textit{[Le retour et la joie des apôtres]}
...
\textit{[Le prochain et la parabole du Samaritain]}
...
\textit{[Jésus chez Marthe et Marie]}
...
\textit{[Parabole du riche insensé]}
...
\textit{[Exhortation à se confier en Dieu]}
...
\textit{[Parabole et avertissement sur la seconde venue du Messie]}
...
\textit{[Parabole des deux serviteurs]}
...
\textit{[Divisions amenées par l'Evangile]}
...
\textit{[Le discernement des temps]}
...
\textit{[Exhortation à la repentance]}
\Chap{13}
...
\textit{[Guérison d'une femme le jour du sabbat]}
...
\textit{[Jésus guérit un hydropique le jour du sabbat]}
\Chap{14}
...
\textit{[Instructions sur l'humilité]}
...
\textit{[Instructions sur la bienfaisance]}
...
\textit{[Jésus justifie sa conduite envers les pécheurs par les paraboles]}
\Chap{15}
...
\textit{[Parabole de l'économe infidèle]}
\Chap{16}
...
\textit{[Nul ne peut servir deux maîtres. Reproches aux pharisiens]}
...
\textit{[Enseignement de Jésus sur le divorce]
...
\textit{[Histoire de l’homme riche et de Lazare]}
...
\VS{22}Le pauvre mourut, et il fut porté par les anges dans le sein d'Abraham. Le riche mourut aussi, et il fut enseveli.
...
\textit{[Instructions de Jésus au sujet des scandales, du pardon et de la foi]
\\(Mt. 5:31-32;19:1-9: Mc. 10:2-12)}
\Chap{17}
...
\textit{[Les pharisiens demandent à voir le  Royaume de Dieu]}
...
\textit{[Jésus prédit sa seconde venue]}
...
\textit{[Parabole du pharisien et du publicain]}
...
\textit{[Jésus prédit à nouveau sa mort et sa résurrection]
...
\textit{[Bartimée recouvre la vue]
...
\textit{[Jésus fait son entrée à Jérusalem]
\\(Mt. 21:1-11; Mc. 11:1-11; Jn. 12:12-19; cp. Zn. 9:9)}
...
\textit{[Jésus pleure de nouveau sur Jérusalem]}
...
\textit{[Il chasse du temple les marchands]}
...
\textit{[L'autorité de Jésus et celle de Jean-Baptiste]}
\Chap{20}
...
\\(Mt. 21:33-46; Mc. 12:1-12; cp. Es. 5:1-7)}
...
\textit{[Le Messie, fils et Seigneur de David]}
...
\textit{[Offrande de la pauvre veuve]}
\Chap{21}
...
\textit{[Jésus prophétise la persécution des siens et la ruine de Jérusalem]}
...
\textit{[Institution du repas de la pâque]}
...
\textit{[Prophétie sur la chute de Pierre]}
...
\textit{[Jésus est conduit chez le souverain sacrificateur]}
...
\textit{[Jésus est renié par Pierre]}
...
\textit{[Jésus déclare qu'il est le Fils de Dieu]}
...
\textit{[Jésus devant Pilate et devant Hérode]}
\Chap{23}
...
\textit{[Pilate déclare Jésus innocent, puis l'abandonne. Barabbas relâché]}
...
\textit{[Prophétie sur la ruine de Jérusalem]}
...
\textit{[Deux malfaiteurs crucifiés avec lui]}
...
\textit{[Résurrection du Seigneur - les femmes et les apôtres au sépulcre]}
\Chap{24}
...
\textit{[Jésus apparaît à deux disciples sur le chemin d'Emmaüs]}
...
\textit{[Jésus apparaît aux apôtres à Jérusalem]}
