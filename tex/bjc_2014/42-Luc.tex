...
\TextTitle{[Jésus est Maïtre du sabbat]
...
\TextTitle{[Choix des douze apôtre]
...
\TextTitle{[Le sermon sur la montagne]
\\(Mt. 5-7)}
...
\TextTitle{[Parabole des deux maisons]}
...
\TextTitle{[Jésus fait l'éloge de Jean-Baptiste]
\\(Mt. 11:1-19)}
...
\TextTitle{[Jésus, oint par une pêcheresse dans la maison d'un pharisien]}
...
\TextTitle{[Les femmes qui servirent Jésus durant son ministère]}
\Chap{8}
...
\TextTitle{[Les nouvelles relations]
...
\VS{29}Car Jésus commandait à l'esprit impur de sortir de cet homme, dont il s’était emparé depuis longtemps. On le gardait lié de chaines et les fers aux pieds, mais il rompait les liens, et il était entrainé par le démon dans les déserts.
...
\TextTitle{[Jésus prédit sa mort et sa résurrection]
...
\TextTitle{[Prix de la consécration du chrétien]
...
\TextTitle{[La transfiguration de Jésus]
\\(Mt. 17:1-8 ; Mc. 9:1-8)}
...
\TextTitle{[Jésus prédit de nouveau sa mort et sa résurrection]
...
\TextTitle{[L'humilité, le secret de la vértiable grandeur]
...
\VS{4}Pardonne-nous nos péchés ; car nous aussi, nous pardonnons à quiconque nous offense ; et ne nous induis point en tentation, mais délivre-nous du mal.
\TextTitle{[Parabole des trois amis et de la prière importune]}
\VS{5}Puis il leur dit : Si l’un de vous a un ami, et qu’il aille le trouver au milieu de la nuit pour lui dire : Mon ami, prête-moi trois pains,
...
\VS{9}Ainsi je vous le dis : Demandez, et il vous sera donné ; cherchez, et vous trouverez ; frappez, et l’on vous ouvrira.
...
\VS{14}Jésus chassa un démon qui était muet. Lorsque le démon fut sorti, le muet parla ; et la foule fut dans l’admiration.
\TextTitle{[Le blasphème contre le Saint-Esprit]
\\(Mt. 12:24-32 ; Mc. 3:22-30)}
\VS{15}Mais quelques-uns d'entre eux dirent : C’est par Béelzebul\FTNT{Béelzebul : Dans 2 R. 1:2, il est fait mention de ~Baal Zebub, dieu d'Eqrôn~. Littéralement, la formule signifie ~maître (Baal) des mouches~, acception que le grec de la Septante a adoptée en traduisant par Baal-myia, ~Baal-mouche~. Le prince de démons.} (1), prince des démons, qu'il chasse les démons.
\VS{16}Mais les autres pour l'éprouver, lui demandaient un signe venant du ciel.
\VS{17}Comme Jésus connaissait leurs pensées, il leur dit : Tout royaume divisé contre lui-même sera réduit en désert ; et toute maison divisée contre elle-même tombe en ruine.
...
\VS{26}Alors il s'en va, et prend avec lui sept autres esprits plus méchants que lui, ils entrent dans la bergerie, s’y établissent, et la dernière condition de cet homme est pire que la première.
\VS{27}Tandis que Jésus parlait ainsi, une femme élevant sa voix du milieu de la foule, lui dit : Heureux le sein qui t'a porté ! Heureuses les mamelles qui t’ont allaité !
...
\\(Mt. 12:38-41)}
\VS{29}Comme le peuple s’amassait en foule, il se mit à dire : Cette génération est méchante ; elle demande un miracle, mais il ne lui sera donné d’autre miracle que celui de Jonas le prophète.
...
\VS{33}Personne n’allume une lampe pour la mettre dans un lieu caché ou sous le boisseau, mais on la met sur un chandelier, afin que ceux qui entrent voient la lumière.
\VS{34}L’œil est la lumière du corps. Si donc ton œil est sain, tout ton corps aussi sera éclairé ; mais s'il est en mauvais état, ton corps sera dans les ténèbres.
...
\TextTitle{[Jésus, source de division entre les hommes sur des questions spirituelles]}
...
\VS{58}Lorsque tu vas avec ton adversaire devant le magistrat, tâche en chemin de te dégager de lui, de peur qu’il ne te traine devant le juge, et que le juge ne te livre à l’officier de justice et que celui-ci ne te mette en prison.
...
\TextTitle{[Guérison d'une femme le jour du sabbat]}
...
\TextTitle{[Jésus justifie sa conduite envers les pécheurs par les paraboles]}
\Chap{15}
...
\TextTitle{[Parabole de la drachme perdue grandeur]}
...
\VS{16}La loi et les prophètes ont duré jusqu'à Jean ; depuis lors, le Royaume de Dieu est annoncé, et chacun use de violence pour y entrer.
...
\TextTitle{[Jésus prédit sa seconde venue]
\\(voir De. 30:3)}
...
\VS{18}Un chef l'interrogea Jésus et dit : Bon Maître, que dois-je faire pour hériter la vie éternelle ?
...
\TextTitle{[Récompense pour tous ceux qui ont tout abandonné pour suivre Jésus]}
...
\TextTitle{[Jésus prédit à nouveau sa mort et sa résurrection]
...
\VS{32}Car il sera livré aux païens ; on se moquera de lui, on l’outragera, et on lui crachera au visage,
...
\TextTitle{[Bartimée recouvre la vue]
...
\TextTitle{[Jésus pleure de nouveau sur Jérusalem]
\\(cp. Mt. 23:37-39 ; Lu. 13:34-35)}
\VS{41}Comme il approchait de la ville, Jésus, en la voyant, pleura sur elle, et dit :
\VS{42}O ! Si toi aussi, au moins en ce jour qui t’est donné, tu connaissais les choses qui appartiennent à ta paix ! Mais maintenant elles sont cachées à tes yeux.
...
\TextTitle{[Jésus répond aux hérodiens : le tribut à César]
...
\TextTitle{[Discours sur le mont des Oliviers]
\\(Mt. 24-25 ; Mc. 13)}
...
\TextTitle{[Prophétie sur la destruction de Jérusalem]}
...
\\(Mt. 26:20-25 ; Mc. 14:17-21 ; Jn. 13:1-12)}
...
\TextTitle{[Jésus déclare qu'il est le Fils de Dieu]
...
\TextTitle{[Repentance d'un deux malfaiteurs crucifiés avec Jésus]
...
\TextTitle{[Ténébres pendant trois heures, Jésus remet son Esprit]
...
\TextTitle{[Résurrection de Christ et événements consécutifs]
...
\TextTitle{[Jésus apparaît à deux disciples sur le chemin d'Emmaüs]
\\(Mc. 16:12-13)}
...
\VS{25}Alors Jésus leur : Ô hommes sans intelligence, et dont le cœur est lent à croire tout ce qu’ont annoncé les prophètes !
...
\TextTitle{[Jésus confie une nouvelle mission aux onze]
